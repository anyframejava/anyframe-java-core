...
public class MovieFinderImpl implements MovieFinder {
	...
	public Page getPagingListWithDate(String startDate, String endDate, int pageIndex) throws Exception {
		return movieDao.getPagingListWithDate(startDate, endDate, pageIndex);
	}
