...
public class MovieDao extends QueryServiceDaoSupport {
	...
	public void create(Movie movie) {
		super.create("createVoMovie", movie);
	}

	public void remove(String movieId) {
		Movie movie = new Movie();
		movie.setMovieId(movieId);
		super.remove("removeVoMovie", movie);
	}

	public void update(Movie movie) {
		super.update("updateVoMovie", movie);
	}

	public Movie get(String movieId) {
		Movie movie = new Movie();
		movie.setMovieId(movieId);
		return super.findByPk("findVoMovieByPk", movie);
	}

	public Page getPagingList(MovieSearchVO search) {
		return super.findListWithPaging("findVoMovieList", search, search
