 ...
 */
package org.anyframe.plugin.login.moviefinder.service.web;
...
import org.anyframe.plugin.login.domain.Genre;
import org.anyframe.plugin.login.domain.Movie;
import org.anyframe.plugin.login.moviefinder.service.GenreService;
import org.anyframe.plugin.login.moviefinder.service.MovieService;
 ...
 * @author Sooyeon Park
 */
@Controller("loginMovieController")
@RequestMapping("/loginMovie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("loginMovieService")
	private MovieService movieService;

	@Inject
	@Named("loginGenreService")
	...
	public String create(
		...
		return "redirect:/loginMovieFinder.do?method=list";
	}
