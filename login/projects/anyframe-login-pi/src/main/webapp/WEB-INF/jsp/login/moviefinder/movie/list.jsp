...
<head>
	...
	<script type="text/javascript">
		function fncCreateMovieView() {
			document.location.href="<c:url value='/loginMovie.do?method=createView'/>";
		}	
		function fncSearchMovie(arg) {
		   	document.searchForm.action="<c:url value='/loginMovieFinder.do?method=list'/>";
		   	document.searchForm.submit();						
		}	
		function fncChangeLocale(arg) {
		   	document.searchForm.action="<c:url value='/loginChangeLocale.do?locale='/>" + arg;
		   	document.searchForm.submit();						
		}	
		function fncLogout() {
		   	document.searchForm.action="<c:url value='/logout.do'/>";
		   	document.searchForm.submit();						
		}	
	</script>
</head>
	...
	<tr>
		...
		<table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td align="right" class="underline" width="16" style="padding-left: 12px"><a href="javascript:fncChangeLocale('ko');"><img src="<c:url value='/sample/images/kr.png'/>" width="16" height="11" border="0" align="absmiddle" /></a></td>
				<td align="right" class="underline" width="16" style="padding-left: 12px"><a href="javascript:fncChangeLocale('en');"><img src="<c:url value='/sample/images/en.png'/>" width="16" height="11" border="0" align="absmiddle"/></a></td>
				<td align="right" class="underline" width="16" style="padding-left: 12px"><a href="javascript:fncLogout();">Logout</a></td>
			</tr>
		</table>
		</td>
	</tr>
		...
		<tbody>
			<c:forEach var="movie" items="${movies}">
				<tr class="board" onMouseOver="this.style.backgroundColor='#e4eaff';return true;" onMouseOut="this.style.backgroundColor=''; return true;" >
					...
					<td class="underline">
						<a class="linkClass" href="${ctx}/loginMovie.do?method=get&movieId=${movie.movieId}">${movie.title}</a>
					</td>
