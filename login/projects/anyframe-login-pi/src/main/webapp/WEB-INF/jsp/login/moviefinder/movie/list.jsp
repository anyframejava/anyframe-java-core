...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/loginView.do'/>">Login 1.0.1</a></div>
    </div>
    <hr />
  	...
  	<form:form modelAttribute="movie" method="post" name="searchForm">
    	<div class="cont_top">
        	<h2><spring:message code='movie.heading'/></h2>
      		...
      		<div style="top:13px;margin:5px 0;" class="list_underbtn_right">
        		<a href="javascript:fncChangeLocale('ko');"><img src="<c:url value='/sample/images/img_flag_ko.gif'/>" alt="한국 국기" /></a>
				<a href="javascript:fncChangeLocale('en');"><img src="<c:url value='/sample/images/img_flag_en.gif'/>" alt="미국 국기" /></a>
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                        ...
	                        <td><a class="linkClass" href="${ctx}/loginMovie.do?method=get&amp;movieId=${movie.movieId}">${movie.title}</a></td>
