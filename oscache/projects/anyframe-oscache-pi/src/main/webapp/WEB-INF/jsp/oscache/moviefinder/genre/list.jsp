...
<script type="text/javascript">
		function fncCreateGenreView() {
			document.location.href="<c:url value='/oscacheGenre.do?method=createView'/>";
		}	
		function fncSearchGenre() {
		   	document.searchForm.action="<c:url value='/oscacheGenre.do?method=list'/>";
      		...
      		<table summary="This is list of Genre">
                ...
                <tbody>
                	<c:forEach var="genre" items="${genres}">
	                	<tr>
	                        <td><a class="linkClass" href="${ctx}/oscacheGenre.do?method=get&genreId=${genre.genreId}">${genre.genreId}</a></td>
