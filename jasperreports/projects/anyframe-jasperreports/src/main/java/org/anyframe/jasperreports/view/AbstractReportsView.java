 ...
 * <br><br>
 * We changed org.springframework.web.servlet.view.jasperreports.AbstractJasperReportsView Class into org.anyframe.jasperreports.AbstractReportsView Class in Anyframe.
 * 
 * @since 1.1.3
 * 
 * @author Rob Harrop
...
public abstract class AbstractReportsView extends AbstractUrlBasedView {
	...
	protected JRExporterParameter convertToExporterParameter(String fqFieldName) {
		...
		try {
			Class cls = Class.forName(className);//ClassUtils.forName(className);
