            ...
            <caption>A list of installed plugins</caption>
            	...
            	<tr>
                    ...
                    <td>
						...
						<li><a href="<c:url value='/reports/movieReport.html'/>">Jasper Reports 1.0.2(HTML)</a></li>
						<li><a href="<c:url value='/reports/movieReport.pdf'/>">Jasper Reports 1.0.2(PDF)</a></li>
