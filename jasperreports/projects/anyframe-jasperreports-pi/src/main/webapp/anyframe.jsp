            	...
            	<tr>
                    ...
                    <td>
                    	<ul>
							...
							<li><a href="<c:url value='/reports/movieReport.html'/>">Jasper Reports 1.0.1(HTML)</a></li>
							<li><a href="<c:url value='/reports/movieReport.pdf'/>">Jasper Reports 1.0.1(PDF)</a></li>
