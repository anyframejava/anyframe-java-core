    ...
    <hr />
  	<div id="container">
    	<div class="main_greeting">
        	<dl>
                <dt>Welcome to Anyframe 5.5.1-SNAPSHOT</dt>
        ...
        <div class="itemBox_1">
            ...
            <caption>A list of installed plugins</caption>
            	...
            	<tr>
                    ...
                    <td>
                    	<!--Add new menu here-->
						<!--jasperreports-menu-START-->
						<li><a href="<c:url value='/reports/movieReport.html'/>">Jasper Reports 1.0.3-SNAPSHOT(HTML)</a></li>
						<li><a href="<c:url value='/reports/movieReport.pdf'/>">Jasper Reports 1.0.3-SNAPSHOT(PDF)</a></li>
						<!--jasperreports-menu-END-->
                    </td>
                </tr>
            </table>
        </div>
