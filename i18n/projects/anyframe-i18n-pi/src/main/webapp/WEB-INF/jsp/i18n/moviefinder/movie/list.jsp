    	...
    	<div class="cont_top">
        	<h2><spring:message code='movie.heading'/></h2>
      		...
      		<div style="top:13px;margin:5px 0;" class="list_underbtn_right">
				...
				<a href="javascript:fncLogout();"><spring:message code="i18n.logout"/></a>
			</div>
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                        ...
	                        <td><a class="linkClass" href="${ctx}/i18nMovie.do?method=get&amp;movieId=${movie.movieId}">${movie.title}</a></td>
