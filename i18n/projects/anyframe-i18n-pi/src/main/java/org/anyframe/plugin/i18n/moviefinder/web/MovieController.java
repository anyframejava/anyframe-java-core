...
import org.anyframe.plugin.i18n.domain.Genre;
import org.anyframe.plugin.i18n.domain.Movie;
import org.anyframe.plugin.i18n.moviefinder.service.GenreService;
import org.anyframe.plugin.i18n.moviefinder.service.MovieService;
 ...
 * @author Sooyeon Park
 */
@Controller("i18nMovieController")
@RequestMapping("/i18nMovie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("i18nMovieService")
	private MovieService movieService;

	@Inject
	@Named("i18nGenreService")
	...
	public String createView(Model model) throws Exception {
		...
		return "i18n/moviefinder/movie/form";
	}
