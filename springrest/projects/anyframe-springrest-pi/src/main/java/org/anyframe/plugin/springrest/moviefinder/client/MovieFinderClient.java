...
public class MovieFinderClient {
	...
	public Page findMovieList() {
		String movieSearchUrl = "http://localhost:8080/anyframe-springrest-pi/springrest/movies";
	...
	public String createMovie(Movie movie) throws Exception {
		String movieCreateUrl = "http://localhost:8080/anyframe-springrest-pi/springrest/movies";
	...
	public Movie findMovie(String movieId) {
		String movieSearchUrl = "http://localhost:8080/anyframe-springrest-pi/springrest/movies/{movieId}";
