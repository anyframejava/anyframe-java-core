...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/springrest/movies.html'/>">Spring REST Example 1.0.3.RC1</a></div>
    </div>
    <hr />
<script type="text/javascript" src="<c:url value='/sample/javascript/CommonScript.js'/>"></script>    
<script type="text/javascript">
function fncCreateMovieView() {
	document.location.href="<c:url value='/springrest/movies/new.html'/>";
}
function fncSearchMovie() {
	document.searchForm.action="<c:url value='/springrest/movies.html'/>";
	document.searchForm.submit();
}		
</script>
  	<div id="container">
  	<form:form modelAttribute="movie" method="get" name="searchForm">
    	<div class="cont_top">
        	<h2><spring:message code='movie.heading'/></h2>
      		<div class="search_list">
                <fieldset>
                    ...
                    <form:select path="nowPlaying" id="nowPlaying" class="w_search" >
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                    	...
	                    	<spring:url value="/springrest/movies/{id}.html" var="movieUrl" htmlEscape="true">
								<spring:param name="id" value="${movie.movieId}" />
							</spring:url>
	                        <td><a class="linkClass" href="${movieUrl}">${movie.title}</a></td>
