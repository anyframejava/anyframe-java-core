...
<script type="text/javascript">
	function fncCreateMovie() {
	    document.movieForm.action="<c:url value='/tilesMovie.do?method=create'/>";
	    document.movieForm.submit();
	}
	
	function fncUpdateMovie() {
	    document.movieForm.action="<c:url value='/tilesMovie.do?method=update'/>";
	    document.movieForm.submit();
	}
	
	function fncRemoveMovie(){	
		if(confirmDelete('movie')) {
		    document.movieForm.action="<c:url value='/tilesMovie.do?method=remove'/>";
		    document.movieForm.submit();
		}	    
	}	
</script>    
<div id="container">
    ...
    <div class="btncontainer_center">
	    <a href="<c:url value='tilesMovieFinder.do?method=list'/>">
