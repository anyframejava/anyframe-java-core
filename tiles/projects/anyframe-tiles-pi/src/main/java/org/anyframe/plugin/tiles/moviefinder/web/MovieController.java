...
import org.anyframe.plugin.tiles.moviefinder.service.MovieService;
 ...
 * @author Sooyeon Park
 */
@Controller("tilesMovieController")
@RequestMapping("/tilesMovie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("tilesMovieService")
	private MovieService movieService;

	@Inject
	@Named("tilesGenreService")
