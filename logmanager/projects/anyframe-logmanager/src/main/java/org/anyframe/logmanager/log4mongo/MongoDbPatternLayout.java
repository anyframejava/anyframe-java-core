...
public class MongoDbPatternLayout extends PatternLayout {
	...
	public MongoDbPatternLayout(String pattern) {
		this.conversionPattern = "{\"" + pattern.replaceAll(",", "\",\"").replaceAll(":", "\":\"") + "\"}";
		headConverter = createPatternParser((pattern == null) ? DEFAULT_CONVERSION_PATTERN : pattern).parse();
	}

	@Override
	public void setConversionPattern(String conversionPattern) {
		this.conversionPattern = "{\"" + conversionPattern.replaceAll(",", "\",\"").replaceAll(":", "\":\"") + "\"}";
		headConverter = createPatternParser(this.conversionPattern).parse();
	}
