...
import org.anyframe.plugin.logmanager.moviefinder.service.MovieFinder;
 ...
 * @author Heewon Jung
 */
@Controller("logmanagerMovieFinderController")
@RequestMapping("/logmanagerMovieFinder.do")
public class MovieFinderController {

	@Inject
	@Named("logmanagerMovieFinder")
	...
	public String list(
		...
		return "logmanager/moviefinder/movie/list";
	}
}
