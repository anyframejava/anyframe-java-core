...
import org.anyframe.plugin.logmanager.domain.Genre;
import org.anyframe.plugin.logmanager.domain.Movie;
import org.anyframe.plugin.logmanager.moviefinder.service.GenreService;
import org.anyframe.plugin.logmanager.moviefinder.service.MovieService;
 ...
 * @author Heewon Jung
 */
@Controller("logmanagerMovieController")
@RequestMapping("/logmanagerMovie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("logmanagerMovieService")
	private MovieService movieService;

	@Inject
	@Named("logmanagerGenreService")
	...
	public String createView(Model model) throws Exception {
		...
		return "logmanager/moviefinder/movie/form";
	}
