...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/coreMovieFinder.do?method=list'/>">Core 1.0.3</a></div>
    </div>
    <hr />
...
<script type="text/javascript">
    ...
    <div id="container">
        ...
        <span class="button default icon">
            ...
            <a href="<c:url value='/coreMovieFinder.do?method=list'/>"><spring:message code="movie.button.list" /></a>
        </span>
        <c:if test="${empty movie.movieId}">
	        <span class="button default icon">
	            <span class="add"></span>
