...
<script type="text/javascript">
	function fncCreateMovieView() {
		document.location.href="<c:url value='/logmanagerMovie.do?method=createView'/>";
	}	
	function fncSearchMovie() {
	   	document.searchForm.action="<c:url value='/logmanagerMovieFinder.do?method=list'/>";
  	...
  	<form:form modelAttribute="movie" method="post" name="searchForm">
        	...
        	<h2><spring:message code='movie.heading'/></h2>
      		<div class="search_list">
                <fieldset>
                    ...
                    <label for="txtSearch" class="float_left margin_right5"><spring:message code="movie.title"/>: <input name="title" type="text" id="txtSearch" class="w_search" /></label>
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                        ...
	                        <td><a class="linkClass" href="${ctx}/logmanagerMovie.do?method=get&amp;movieId=${movie.movieId}">${movie.title}</a></td>
        ...
        <div class="listunder_container">           
            ...
            <div class="list_underbtn_right">
                <span class="button default icon">
                    <span class="add">&nbsp;</span>
                    <a href="javascript:fncCreateMovieView();"><spring:message code="movie.button.add" /></a>
                </span>
            </div>
        </div>
        </form:form>
