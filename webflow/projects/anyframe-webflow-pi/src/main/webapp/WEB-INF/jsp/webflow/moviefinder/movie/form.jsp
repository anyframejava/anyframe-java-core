...
<head>
	...
	function fncCreateMovie() {
		if(document.movieForm.nowPlaying.checked)
			document.movieForm._nowPlaying.value = "Y";
		else
			document.movieForm._nowPlaying.value = "N";
	...
	function fncUpdateMovie() {
		if(document.movieForm.nowPlaying.checked)
			...
			document.movieForm._nowPlaying.value = "N";
		document.movieForm._eventId.value="update";
		document.movieForm.submit();
	}
	
	function fncRemoveMovie(){	
		if(confirmDelete('movie')) {
			document.movieForm._eventId.value="remove";
		    document.movieForm.submit();
		}	    
	}
...
<form:form modelAttribute="movie" name="movieForm" method="post">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<td class="ct_write01">
				<form:input path="actors" cssClass="ct_input_g" cssErrorClass="text medium error" size="60" maxlength="50" /><form:errors path="actors" cssClass="errors" />
			</td>
		</tr>
		<tr>
			<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		...
		<tr>
			...
			<td class="ct_write01">
				...
				<a href="javascript:popUpCalendar(document.movieForm.releaseDate, 'releaseDate', 'yyyy-mm-dd');"><img src="<c:url value='/sample/images/ct_icon_date.gif'/>" width="16" height="18" border="0" align="absmiddle"></img></a>
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<td class="ct_write01"><form:input path="ticketPrice" cssClass="ct_input_g" cssErrorClass="text medium error" maxlength="4" /><form:errors path="ticketPrice" cssClass="errors" /></td>
		</tr>
		<tr>
			<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		</tr>
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<td class="ct_write01">Is this movie now playing ? <form:checkbox path="nowPlaying" value="Y"/></td>
		</tr>
	</table>
	<!-- begin of button -->
