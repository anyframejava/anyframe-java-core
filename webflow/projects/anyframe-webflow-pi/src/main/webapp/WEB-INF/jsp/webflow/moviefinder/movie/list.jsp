...
<head>
    ...
    <title><anyframe:message code="movieList.title"/></title>
	<meta name="heading" content="<anyframe:message code='movieList.heading'/>"/>       
	<link rel="stylesheet" href="<c:url value='/sample/css/admin.css'/>" type="text/css">
    <script type="text/javascript" src="<c:url value='/sample/javascript/CommonScript.js'/>"></script>    
	<script type="text/javascript">
		function fncCreateMovieView() {
			document.location.href="<c:url value='/webflowMovieCreateView.do'/>";
		}	
		function fncSearchMovie(arg) {
		   	document.searchForm.action="<c:url value='/webflowMovieFinder.do?method=list'/>";
...
<form:form modelAttribute="movie" method="post" name="searchForm">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px; vertical-align: center;">
		<tr>
			<td align="right">
				<label><anyframe:message code="movie.title" />: <form:input path="title" cssClass="ct_input_g" cssErrorClass="text medium error" maxlength="50" /></label>
				
			</td>
			<td align="right" width="180">
				<anyframe:message code="movie.nowPlaying" />: 
	...
	<table class="scrollTable" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
		<thead>
			<tr>
				<th scope="col" style="border-right: 1px #CCCCCC solid"><anyframe:message code="movie.genre" /></th>
				<th scope="col" style="border-right: 1px #CCCCCC solid"><anyframe:message code="movie.title" /></th>
				<th scope="col" style="border-right: 1px #CCCCCC solid"><anyframe:message code="movie.director" /></th>
				<th scope="col" style="border-right: 1px #CCCCCC solid"><anyframe:message code="movie.actors" /></th>
				<th scope="col" style="border-right: 1px #CCCCCC solid"><anyframe:message code="movie.ticketPrice" /></th>
				<th scope="col" style="border-right: 1px #CCCCCC solid"><anyframe:message code="movie.releaseDate" /></th>
			</tr>
		</thead>
		<tbody>
			<c:forEach var="movie" items="${movies}">
				<tr class="board" onMouseOver="this.style.backgroundColor='#e4eaff';return true;" onMouseOut="this.style.backgroundColor=''; return true;" >
					...
					<td class="underline">
						<a class="linkClass" href="${ctx}/webflowMovieUpdate.do?movieId=${movie.movieId}">${movie.title}</a>
					</td>
