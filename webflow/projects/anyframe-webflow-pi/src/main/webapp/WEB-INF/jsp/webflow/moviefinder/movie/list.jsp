...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/webflowMovieFinder.do?method=list'/>">Webflow 1.0.2</a></div>
    </div>
    <hr />
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                        ...
	                        <td><a class="linkClass" href="${ctx}/webflowMovieUpdate.do?method=get&amp;movieId=${movie.movieId}">${movie.title}</a></td>
