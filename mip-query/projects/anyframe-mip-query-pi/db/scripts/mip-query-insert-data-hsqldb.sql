CREATE SEQUENCE CATEGORY_ID_SEQ AS INTEGER START WITH 1101; 
CREATE SEQUENCE COMMUNITY_ID_SEQ AS INTEGER START WITH 1101; 
CREATE SEQUENCE POST_ID_SEQ AS INTEGER START WITH 11001; 
CREATE SEQUENCE USER_ID_SEQ AS INTEGER START WITH 1101; 
CREATE SEQUENCE SCHD_ID_SEQ AS INTEGER START WITH 1101; 
CREATE SEQUENCE FILE_ID_SEQ AS INTEGER START WITH 1101;
CREATE MEMORY TABLE MIP_CATEGORY(CATEGORY_ID VARCHAR(16) NOT NULL,CATEGORY_NAME VARCHAR(50) NOT NULL,CATEGORY_DESC VARCHAR(100),REG_DATE DATE,CONSTRAINT PK_MIP_CATEGORY PRIMARY KEY(CATEGORY_ID));
CREATE MEMORY TABLE MIP_COMMUNITY(COMMUNITY_ID VARCHAR(16) NOT NULL,COMMUNITY_NAME VARCHAR(50) NOT NULL,COMMUNITY_DESC VARCHAR(100),CATEGORY_ID VARCHAR(16),REG_ID VARCHAR(20),REG_DATE DATE,CONSTRAINT PK_MIP_COMMUNITY PRIMARY KEY(COMMUNITY_ID),CONSTRAINT FK_MIP_CATEGORY FOREIGN KEY(CATEGORY_ID) REFERENCES MIP_CATEGORY(CATEGORY_ID));
CREATE MEMORY TABLE MIP_BOARD(POST_ID VARCHAR(16) NOT NULL,TITLE VARCHAR(50) NOT NULL,CONTENTS VARCHAR(255),REG_ID VARCHAR(20),REG_DATE DATE,COMMUNITY_ID VARCHAR(16) NOT NULL,CONSTRAINT PK_MIP_BOARD PRIMARY KEY(POST_ID),CONSTRAINT FK_MIP_COMMUNITY FOREIGN KEY(COMMUNITY_ID) REFERENCES MIP_COMMUNITY(COMMUNITY_ID));
CREATE MEMORY TABLE MIP_ATTACH(FILE_ID VARCHAR(16) NOT NULL,FILE_PATH VARCHAR(256),FILE_NAME VARCHAR(128),FILE_EXT VARCHAR(5),FILE_SIZE VARCHAR(20),CONTENTS LONGVARBINARY,POST_ID VARCHAR(16) NOT NULL,CONSTRAINT PK_MIP_ATTACH PRIMARY KEY(FILE_ID),CONSTRAINT FK_MIP_ATTACH FOREIGN KEY(POST_ID) REFERENCES MIP_BOARD(POST_ID));
CREATE MEMORY TABLE MIP_DEPT(DEPT_ID VARCHAR(16) NOT NULL,DEPT_NAME VARCHAR(20) NOT NULL,DEPT_LEVEL VARCHAR(1),DEPT_DESC VARCHAR(100),PARENT_DEPT VARCHAR(16),CONSTRAINT PK_MIP_DEPT PRIMARY KEY(DEPT_ID));
CREATE MEMORY TABLE MIP_SCHD(SCHD_ID VARCHAR(16) NOT NULL,USER_ID VARCHAR(16),SCHD_TITLE VARCHAR(50) NOT NULL,SCHD_CONTENTS VARCHAR(100),SCHD_STARTDATE DATE,SCHD_ENDDATE DATE,SCHD_PLACE VARCHAR(50),CONSTRAINT PK_MIP_SCHD PRIMARY KEY(SCHD_ID));
CREATE MEMORY TABLE MIP_USER(USER_NAME VARCHAR(20) NOT NULL,EN_NAME VARCHAR(20),COMP_PHONE VARCHAR(20),PHONE VARCHAR(20),CELL_PHONE VARCHAR(20),COMPANY VARCHAR(20),JOB_POSITION VARCHAR(20),ASSIGNMENT VARCHAR(20),OFFICER_YN VARCHAR(1),FAX VARCHAR(20),ZIP_CODE VARCHAR(10),ADDRESS VARCHAR(100),COMP_ZIP_CODE VARCHAR(10),COMP_ADDRESS VARCHAR(100),EMAIL VARCHAR(30),USER_ID VARCHAR(16) NOT NULL,DEPT_ID VARCHAR(16) NOT NULL,PASSWORD VARCHAR(16) NOT NULL,CONSTRAINT PK_MIP_USER PRIMARY KEY(USER_ID),CONSTRAINT FK_MIP_DEPT FOREIGN KEY(DEPT_ID) REFERENCES MIP_DEPT(DEPT_ID));
