...
CREATE MEMORY TABLE MIP_ATTACHED(ID VARCHAR(50) NOT NULL,NAME VARCHAR(255),FILE_SIZE NUMERIC(15),REF_ID VARCHAR(50) NOT NULL,CONSTRAINT PK_FLEX_ATTACHED PRIMARY KEY(ID));
