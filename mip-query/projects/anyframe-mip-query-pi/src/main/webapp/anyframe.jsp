            	...
            	<tr>
                    ...
                    <td>
                    	<ul>
                            ...
                            <li><a href="<c:url value='/mip-query/basic/mipQuery.jsp'/>">MiP-Query 1.5.2-SNAPSHOT(MipService)</a></li>
                            <li><a href="<c:url value='/mipQueryMovieFinder.do'/>">MiP-Query 1.5.2-SNAPSHOT(Extensions)</a></li>
