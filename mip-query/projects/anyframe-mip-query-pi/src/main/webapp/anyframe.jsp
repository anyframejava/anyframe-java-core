            	...
            	<tr>
                    ...
                    <td>
                    	<ul>
                            ...
                            <li><a href="<c:url value='/mip-query/basic/mipQuery.jsp'/>">MiP-Query 1.0.4(MipService)</a></li>
                            <li><a href="<c:url value='/mipQueryMovieFinder.do'/>">MiP-Query 1.0.4(Extensions)</a></li>
							<!--mip-query-menu-END-->
                        </ul>
                    </td>
                </tr>
