            	...
            	<tr>
                    ...
                    <td>
                    	<ul>
                            ...
                            <li><a href="<c:url value='/mip-query/basic/mipQuery.jsp'/>">MiP-Query 1.6.0(MipService)</a></li>
                            <li><a href="<c:url value='/mipQueryMovieFinder.do'/>">MiP-Query 1.6.0(Extensions)</a></li>
