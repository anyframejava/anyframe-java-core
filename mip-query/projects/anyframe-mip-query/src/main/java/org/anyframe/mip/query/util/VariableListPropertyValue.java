...
public class VariableListPropertyValue extends MutablePropertyValues {
	 ...
	 */
	public VariableListPropertyValue(VariableList variableList, boolean convertToCamelCase){
	 ...
	 */
	public VariableListPropertyValue(Dataset dataList, int rowNum, boolean convertToCamelCase){
	 ...
	 */
	public VariableListPropertyValue(Dataset dataList, int rowNum, boolean isDeleted, boolean convertToCamelCase){
