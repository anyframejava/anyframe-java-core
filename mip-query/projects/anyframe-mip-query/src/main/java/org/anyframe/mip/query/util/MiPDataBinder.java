...
public class MiPDataBinder extends DataBinder {
	...
	public void bind(VariableList variableList) {
		MutablePropertyValues mpvs = new VariableListPropertyValue(variableList,convertToCamelCase);
		doBind(mpvs);
	}	
	...
	public void bind(Dataset dataList, int rowNum) {
		MutablePropertyValues mpvs = new VariableListPropertyValue(dataList, rowNum,convertToCamelCase);
		doBind(mpvs);
	}
	/**
	...
	public void bind(Dataset dataList, int rowNum, boolean isDeleted) {
		MutablePropertyValues mpvs = new VariableListPropertyValue(dataList, rowNum, isDeleted, convertToCamelCase);
		doBind(mpvs);
	}
}
