		...
		<tbody>
			<c:forEach var="genericMovie" items="${genericMovies}">
				<tr class="board" onMouseOver="this.style.backgroundColor='#e4eaff';return true;" onMouseOut="this.style.backgroundColor=''; return true;" >
					<td class="underline">${genericMovie.genre.name}</td>
					<td class="underline">
						<a class="linkClass" href="${ctx}/genericMovie.do?method=get&movieId=${genericMovie.movieId}">${genericMovie.title}</a>
					</td>
					<td align="left">${genericMovie.director}</td>
					<td align="left">${genericMovie.actors}</td>
					<td align="center">${genericMovie.ticketPrice}</td>
					<td align="center">${genericMovie.releaseDate}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
