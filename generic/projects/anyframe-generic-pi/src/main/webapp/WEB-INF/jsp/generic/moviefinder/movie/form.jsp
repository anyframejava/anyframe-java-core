	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
		...
		<tr>
			...
			<td class="ct_write01">
				...
				<a href="javascript:popUpCalendar(document.genericMovieForm.releaseDate, 'yyyy-mm-dd');"><img src="<c:url value='/sample/images/ct_icon_date.gif'/>" width="16" height="18" border="0" align="absmiddle"></img></a>
