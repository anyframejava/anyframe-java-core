 ...
 */
package org.anyframe.plugin.generic.domain;
...
/**
 * This GenericMovie class is a Value Object class for GenericMovie domain.
 * 
...
public class GenericMovie implements Serializable {
	...
	public GenericGenre getGenre() {
		return genre;
	}

	public void setGenre(GenericGenre genericGenre) {
