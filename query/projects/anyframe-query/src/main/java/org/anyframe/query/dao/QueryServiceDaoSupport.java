...
public class QueryServiceDaoSupport {
	 ...
	 * inputed value, queryId which defined in mapping xml files.
	 * 
	 * @param queryID
	 *            identifier of query statement to execute
	 * @param targetObj
	 ...
	 * value, queryId which defined in mapping xml files. At execution of the
	 ...
	 *             if there is any problem executing the query
	 */
	protected int create(String queryId, Map targetMap)
			throws QueryServiceException {
	 ...
	 * the inputed value, queryId which defined in mapping xml files. At the
	 ...
	 * inputed value, queryId which defined in mapping xml files. At the
	 ...
	 *             if there is any problem executing the query
	 */
	protected int update(String queryId, Map targetMap)
			throws QueryServiceException {
		Object[] params = convertParams(targetMap);
		return update(queryId, params);
	}
	 ...
	 * inputed value, queryId which defined in mapping xml files. Define as
	 ...
	 * the input value, queryId which defined in mapping xml files. At execution
	 ...
	 *             if there is any problem executing the query
	 */
	protected int remove(String queryId, Map targetMap)
			throws QueryServiceException {
		Object[] params = convertParams(targetMap);
		return remove(queryId, params);
	}
	 ...
	 * input value, queryId which defined in mapping xml files. Define as
	 ...
	 *             if there is any problem executing the query
	 */
	protected Object findByPk(String queryId, Object targetObj)
			throws QueryServiceException {
		Object[] params = convertParams(targetObj);
	 ...
	 * including the inputed value, queryId which defined in mapping xml files.
	 ...
	 *             if there is any problem executing the query
	 */
	protected Object findByPk(String queryId, Map targetMap)
			throws QueryServiceException {
		Object[] params = convertParams(targetMap);
		return findByPk(queryId, params);
	}
	 ...
	 *             if there is any problem executing the query
	 */
	protected Object findByPk(String queryId, List targetList)
			throws QueryServiceException {
		Object[] params = convertParams(targetList);
		return findByPk(queryId, params);
	}
	 ...
	 *             if there is any problem executing the query
	 */
	protected Object findByPk(String queryId, Object[] targetObjs)
			throws QueryServiceException {
		Collection collection = queryService.find(queryId, targetObjs);
	 ...
	 *             if there is any problem executing the query
	 */
	protected Collection findList(String queryId, Object targetObj)
			throws QueryServiceException {
		Object[] params = convertParams(targetObj);
	 ...
	 * input value, queryId which defined in mapping xml files. Define as key of
	 ...
	 *             if there is any problem executing the query
	 */
	protected Collection findList(String queryId, Map targetMap)
			throws QueryServiceException {
		Object[] params = convertParams(targetMap);
		return queryService.find(queryId, params);
	}
	 ...
	 * inputed value, queryId which defined in mapping xml files. Define key as
	 ...
	 *             if there is any problem executing the query
	 */
	protected Collection findList(String queryId, List targetObjs)
			throws QueryServiceException {
		Object[] params = convertParams(targetObjs);
		return queryService.find(queryId, params);
	}
	 ...
	 *             if there is any problem executing the query
	 */
	protected Collection findList(String queryId, Object[] targetObjs)
			throws QueryServiceException {
	 ...
	 * queryId which defined in mapping xml files. Tranmits the result as
	 ...
	 * value, queryId which defined in mapping xml files. Transmit by changing
	 ...
	 * queryId which defined in mapping xml files. Define as the appropriate
	 ...
	 *             if there is any problem executing the query
	 */
	protected Page findListWithPaging(String queryId, Map targetMap,
			int pageIndex, int pageSize) throws QueryServiceException {
	...
	/**
	 * Execute the SELECT query statement using the pageIndex, pageSize and
	 * targetList including the inputed value, queryId which defined in mapping
	 * xml files. Define key as (variableName + order) type in reflecting the
	 ...
	 * queryId which defined in mapping xml files. Define key as (variableName +
	 ...
	 * queryId which defined in mapping xml files. Transmit by changing the
	 ...
	 * queryId which defined in mapping xml files. Transmit by changing as
	 * anyframe.common.Page object type handled in the paginavigator tag for
