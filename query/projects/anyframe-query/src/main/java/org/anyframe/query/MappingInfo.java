...
public interface MappingInfo {
	...
	/**
	 * Transmits the Primary Key columns defined in the mapping info of the
	 * arbitrary table.
	 * 
	...
	/**
	 * Transmits the related class name in defined in the arbitrary table
	 * mapping info.
	 * 
	...
	/**
	 * Tranmits the property name of the mapping class, arbitrary table's column
	 * name.
	 * 
	 * @return The column mapping info of the arbitrary table
	 */
	Map<String, String> getMappingInfoAsMap();

	/**
	 * Based on the arbitrary mapping info, transmits by creating SELECT query
	 * statement including the Named Parameter. The appropriate SELECT statement
	 * is created by using the defined PRIMARY KEY. (Named Parameter is
	...
	/**
	 * Tranmits by creating the INSERT query statement including the Named
	 * Parameter based on the arbitrary table mapping info. (Named Parameter is
	 * "anyframe." + "related class's property name")
	 * 
	...
	/**
	 * Tranmits by creating the UPDATE query statement including the Named
	 * Paremter based on the arbitrary table mapping info. (Named Parameter is
	 * "anyframe." + "related class's property name")
	 * 
	...
	/**
	 * Based on the arbitrary mapping info, trasmits by creating the DELETE
	 * query statement including hte Named Parameter based on the arbitrary
