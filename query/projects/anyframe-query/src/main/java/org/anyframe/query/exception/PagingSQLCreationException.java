...
/**
 * This is an exception class for pagingSQLCreation
 * 
 * @author Jongpil Park
 * 
 * @since 1.1.4
...
public class PagingSQLCreationException extends PersistenceException {
	...
	public PagingSQLCreationException(String message) {
		super(message);
	}
	 ...
	 */
	public PagingSQLCreationException(String message, Throwable exception) {
