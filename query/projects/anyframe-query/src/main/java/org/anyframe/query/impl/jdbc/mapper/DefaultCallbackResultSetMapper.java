...
public class DefaultCallbackResultSetMapper<T> extends CallbackResultSetMapper<T> {
	// 2009.05.28
	public DefaultCallbackResultSetMapper(Class<T> targetClass,
	 ...
	 * SQLLoader. Search return value is saved and Map and transferred. In this
	 * case, key value is expressed in colmnname.
	 * 
	 * @param resultSet
	 *            Search result
