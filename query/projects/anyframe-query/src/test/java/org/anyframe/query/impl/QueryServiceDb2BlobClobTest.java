...
/**
 * TestCase Name : QueryServiceDb2BlobClobTest <br>
 * <br>
 * [Description] : In the case where DBMS type is DB2, CLOB, BLOB Handling
 * methods are tested and verified. <br>
 * [Main Flow]
 * <ul>
 * <li>#-1 Positive Case : After entering BLOB and CLOB type data, relevant data
 * is searched and the result value is verified.</li>
 * <li>#-2 Positive Case : Positive Case : After entering BLOB and CLOB type
 * data, I relevant data is searched and it is put into a specific Result Class.
 * </li>
 */
...
public class QueryServiceDb2BlobClobTest {
	 ...
	 * relevant data is searched and the result value is verified.
	 * 
	 * @throws Exception
	 ...
	 * relevant data is searched and it is put into a specific Result Class.
	 * 
	 * @throws Exception
	 *             throws exception which is from QueryService
	 */
	...
	/**
	 * By calling for create()method of QueryService, BLOB and CLOB type data is
	 * entered.
	 * 
	 * @throws Exception
	 *             throws exception which is from QueryService
