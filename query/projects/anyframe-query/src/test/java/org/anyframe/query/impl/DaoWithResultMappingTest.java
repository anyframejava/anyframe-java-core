...
/**
 * TestCase Name : DaoWithResultMappingTest
 * <br>
 * <br>
 ...
 * XML에 정의된 <result-mapping/> 정보를 기반으로 한다.<br>
 * [Main Flow]
 * <ul>
 ...
 * SELECT 수행 결과를 <result-mapping/>에 정의된 매핑 정보를 기반으로
 * 셋팅하여 전달하고 있다.</li>
 * </ul>
 * @author SoYon Lim
 */
public class DaoWithResultMappingTest extends
     ...
     * <result-mapping/>에 정의된 매핑 정보를 기반으로 셋팅하여 전달하고 있다.
     * @throws Exception
