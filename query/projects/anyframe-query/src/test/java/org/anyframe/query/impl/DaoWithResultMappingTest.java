...
/**
 * TestCase Name : DaoWithResultMappingTest <br>
 * <br>
 * [Description] : This TestCase is to test AbstractDao provided by
 * QueryService. In the case where input/put factor belongs to VO type, query
 * statements on INSERT, UPDATE AND SELECT are executed and the result is
 * verified. However, the output type should be based on <result-mapping/>
 ...
 * result-mapping/> and delivered at UserDaoWithResultClass class.</li>
 * </ul>
 * 
 * @author SoYon Lim
 */
public class DaoWithResultMappingTest extends
    ...
    protected String[] getConfigLocations() {
        return new String[] {
            ...
            "classpath:spring/abstractdao/context-query-sqlloader-resultmapping.xml" };
    }
	 ...
	 * at < result-mapping/> and delivered at UserDaoWithResultClass class.
	 * 
	 * @throws Exception
	 *             throws exception which is from QueryService
	 */
    public void testUserDaoWithResultMapping() throws Exception {
        // 1. insert a new user
