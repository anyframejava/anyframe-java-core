...
/**
 * TestCase Name : QueryServiceWithVONamedParamTest <br>
 * <br>
 * [Description] : When a specific query’s factor value is delivered, transfer
 * object is delivered in the form of named parameter and relevant query is
 * implemented and its result is verified. <br>
 * [Main Flow]
 * <ul>
 * <li>#-1 Positive Case : In the case of calling for update() method provided
 * by QueryService, when a specific query’s factor value is delivered, transfer
 * object is delivered in the form of named parameter. By calling for getter of
 * delivered object, factor value of UPDATE query is set and executed. This
 * TestCase verifies whether relevant query implementation is successful.</li>
 * <li>#-2 Positive Case : In the case of calling for remove() method provided
 * by QueryService, when a specific query’s factor value is delivered, transfer
 * object is delivered in the form of named parameter. By calling for getter of
 * delivered object, factor value of DELETE query is set and executed. This
 * TestCase verifies whether relevant query implementation is successful.</li>
 * </ul>
 * 
 * @author SoYon Lim
...
public class QueryServiceWithVONamedParamTest {
	...
	/**
	 * [Flow #-1] Positive Case : In the case of calling for remove() method
	 * provided by QueryService, when a specific query’s factor value is
	 * delivered, transfer object is delivered in the form of named parameter.
	 * By calling for getter of delivered object, factor value of DELETE query
	 * is set and executed. This TestCase verifies whether relevant query
	...
	public void testUpdateCategory() {
		...
		int result = queryService.update("updateCategory",
				new Object[] { new Object[] { "vo", categoryVO } });
	...
	/**
	 * [Flow #-2] Positive Case : In the case of calling for remove() method
	 * provided by QueryService, when a specific query’s factor value is
	 * delivered, transfer object is delivered in the form of named parameter.
	 * By calling for getter of delivered object, factor value of DELETE query
	 * is set and executed. This TestCase verifies whether relevant query
	...
	public void testDeleteCategory() {
		...
		List<CategoryVO> results = queryService.find("findCategory",
				new Object[] { new Object[] { "vo", categoryVO } });

		// 5. assert
		Assert.assertEquals("Fail to find category list.", 0, results.size());
	}

	/**
	 * By using query I.D. defined at mapping XML file, one piece of data for
	 * test is searched and its result is verified.
	 * 
	 * @return
	 * @throws Exception
	 */
	private CategoryVO insertCategory() {
		// 1. set data for test
	...
	private void findCategory(String categoryNo, String categoryName) {
		...
		// 3. assert
		Assert.assertEquals("Fail to find category list.", 1, results.size());

		// 4. assert in detail
		CategoryVO categoryVO = results.iterator().next();
