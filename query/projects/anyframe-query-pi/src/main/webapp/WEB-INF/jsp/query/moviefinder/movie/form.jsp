...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/queryMovieFinder.do?method=list'/>">Query 1.5.2-SNAPSHOT</a></div>
    </div>
    <hr />
   ...
   <div id="container">
	...
	<form:hidden path="movieId" />
      ...
      <div class="btncontainer_center">
	    <a href="<c:url value='/queryMovieFinder.do?method=list'/>">
