...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/stompMovieFinder.do'/>">Stomp 1.0.0-SNAPSHOT</a></div>
    </div>
    <hr />
...
<script type="text/javascript">
	...
	var protocol = "ws";
	var url = protocol + "://" + window.location.host + "<c:url value='/getMovieList'/>";
	var ws = null;
	var client = null;
