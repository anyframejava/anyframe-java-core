 ...
 * <li>#-6 Positive Case : Post method로 Movie Id가 "005", "006"인 신규 Movie 목록을 생성하는 기능을 호출한다.</li>
 *
 * @author SooYeon Park
 */
...
public class HttpBindingJRATest extends ServerRunner {
	 ...
	 * 
	 * @Get, @HttpResource, @WebResult annotation을 이용하여 findMovieListAll method를
	 *       RESTful한 Web Service로 노출하여 Client가 호출가능하도록 한다. (ex. @Get
	...
	/**
	 * [Flow #-2] Positive Case : URL을 사용하여 Movie Id가 "001"인 Movie를 조회하는 기능을
	 * 호출하여 XML data를 리턴받고 JAXB를 사용하여 Movie 객체로 전환하여 사용한다.
	 * 
	 * @Get, @HttpResource, @WebResult annotation을 이용하여 findMovie method를
	 *       RESTful한 Web Service로 노출하여 Client가 호출가능하도록 한다. (ex. @Get
	 ...
	 * 기능을 호출한다.
	 * 
	 * @Post, @HttpResource annotation을 이용하여 createMovie method를 RESTful한 Web
	 *        Service로 노출하여 Client가 호출가능하도록 한다. (ex. @Post
	...
	/**
	 * [Flow #-5] Positive Case : Delete method로 Movie Id가 "002"인 기존 Movie를 삭제하는
	 * 기능을 호출한다.
	 * 
	 * @Delete, @HttpResource annotation을 이용하여 removeMovie method를 RESTful한 Web
	 *          Service로 노출하여 Client가 호출가능하도록 한다. (ex. @Delete
	...
	/**
	 * [Flow #-6] Positive Case : Post method로 Movie Id가 "005", "006"인 신규 Movie
	 * 목록을 생성하는 기능을 호출한다.
	 * 
	 * @Post, @HttpResource annotation을 이용하여 createMovies method를 RESTful한 Web
	 *        Service로 노출하여 Client가 호출가능하도록 한다. (ex. @Post
