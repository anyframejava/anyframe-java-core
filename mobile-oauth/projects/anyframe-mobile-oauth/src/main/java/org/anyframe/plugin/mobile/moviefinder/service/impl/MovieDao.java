...
public class MovieDao {
	...
	public void create(Movie movie) {
		...
		sqlsession.insert("Movie.insertMovie", movie);
	}

	public void update(Movie movie) {
		sqlsession.update("Movie.updateMovie", movie);
	}

	public void remove(String movieId) {
		sqlsession.delete("Movie.deleteMovie", movieId);
	}

	public Movie get(String movieId) {
		return sqlsession.selectOne("Movie.getMovie", movieId);
	}
