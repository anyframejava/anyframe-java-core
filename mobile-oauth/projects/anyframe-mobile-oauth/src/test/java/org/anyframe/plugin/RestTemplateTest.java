...
public class RestTemplateTest {
	...
	public void restOauthTest() throws Exception {
		...
		headers.set("Authorization", "bearer " + "640dfc06-c905-49cb-8382-67301d7fdea7");
		...
		restTemplate.exchange("http://localhost:1234/movies?startDate=20100201&endDate=20140301&title=&pageIndex=1", HttpMethod.GET, entity, List.class);
		//System.out.println(list.size());
