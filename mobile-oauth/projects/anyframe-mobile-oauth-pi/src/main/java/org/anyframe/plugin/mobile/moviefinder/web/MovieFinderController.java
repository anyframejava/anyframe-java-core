...
public class MovieFinderController {
	...
	public List<?> list2(@RequestParam(value = "startDate", required=false) String startDate, @RequestParam(value = "endDate",required=false) String endDate, @RequestParam(value = "title", required=false) String title, 
			 @RequestParam(value="pageIndex", required=false) String pageIndex, @RequestParam(value="pageSize", required=false) String pageSize) throws Exception {
		...
		Page resultPage = movieFinder.getPagingListWithDate(startDate, endDate, title, index, size);
