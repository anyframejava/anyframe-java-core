...
<script type="text/javascript">
	function fncCreateMovieView() {
		document.location.href="<c:url value='/jasyptMovie.do?method=createView'/>";
	}	
	function fncSearchMovie() {
	   	document.searchForm.action="<c:url value='/jasyptMovieFinder.do?method=list'/>";
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                        ...
	                        <td><a class="linkClass" href="${ctx}/jasyptMovie.do?method=get&amp;movieId=${movie.movieId}">${movie.title}</a></td>
