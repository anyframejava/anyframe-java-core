 ...
 */
package org.anyframe.plugin.jasypt.moviefinder.web;
...
import org.anyframe.plugin.jasypt.moviefinder.service.GenreService;
import org.anyframe.plugin.jasypt.moviefinder.service.MovieService;
 ...
 * @author Sooyeon Park
 */
@Controller("jasyptMovieController")
@RequestMapping("/jasyptMovie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("jasyptMovieService")
	private MovieService movieService;

	@Inject
	@Named("jasyptGenreService")
	...
	public String createView(Model model) throws Exception {
		...
		return "jasypt/moviefinder/movie/form";
	}
	...
	public String create(
		...
		return "redirect:/jasyptMovieFinder.do?method=list";
	}
