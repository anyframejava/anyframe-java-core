...
import org.anyframe.plugin.jasypt.moviefinder.service.MovieFinder;
 ...
 * @author Sooyeon Park
 */
@Controller("jasyptMovieFinderController")
@RequestMapping("/jasyptMovieFinder.do")
public class MovieFinderController {

	@Inject
	@Named("jasyptMovieFinder")
	...
	public String list(
		...
		return "jasypt/moviefinder/movie/list";
	}
}
