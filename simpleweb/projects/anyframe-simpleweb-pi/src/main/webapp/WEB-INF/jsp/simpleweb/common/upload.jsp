...
$(document).ready(function() {
	$("#uploadify").uploadify({
		uploader	: "<c:url value='/simpleweb/jquery/uploadify/uploadify.swf'/>",
		script		: "<c:url value='/simpleFile/upload.do'/>",
		cancelImg	: "<c:url value='/simpleweb/images/cancel.png'/>",
		queueID		: "fileQueue",
		...
		height		: 24,
		sizeLimit	: 10000000,
		buttonImg	: "<c:url value='/simpleweb/images/uploadBrowse.png'/>",
	...
	<tr> 
		<td>
			...
			<div id="buttons" align="center" style="padding-top:5px"> 
				...
				<img id="uploadClearButton" src="<c:url value='/simpleweb/images/clear.jpg'/>" width="57" height="24" border="0" style="padding-bottom:1px;cursor:hand;cursor:pointer;" />
			</div>
		</td>
	</tr>
</table>
