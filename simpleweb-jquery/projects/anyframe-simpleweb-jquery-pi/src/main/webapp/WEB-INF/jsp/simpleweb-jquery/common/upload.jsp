	...
	<tr> 
		<td>
			...
			<div id="buttons" align="center" style="padding-top:5px"> 
				...
				<img id="uploadClearButton" src="<c:url value='/simpleweb-jquery/images/clear.jpg'/>" width="57" height="24" border="0" style="padding-bottom:1px;cursor:hand;cursor:pointer;" />
			</div>
		</td>
	</tr>
</table>
