 ...
 */
package org.anyframe.plugin.ibatis2.moviefinder.web;
...
import org.anyframe.plugin.ibatis2.moviefinder.service.GenreService;
import org.anyframe.plugin.ibatis2.moviefinder.service.MovieService;
 ...
 * @author Sooyeon Park
 */
@Controller("ibatis2MovieController")
@RequestMapping("/ibatis2Movie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("ibatis2MovieService")
	private MovieService movieService;

	@Inject
	@Named("ibatis2GenreService")
	...
	public String create(@Valid Movie movie, BindingResult results,
		...
		return "redirect:/ibatis2MovieFinder.do?method=list";
	}
