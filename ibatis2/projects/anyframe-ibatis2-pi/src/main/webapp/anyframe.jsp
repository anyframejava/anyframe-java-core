    ...
    <hr />
  	<div id="container">
    	<div class="main_greeting">
        	<dl>
                <dt>Welcome to Anyframe 5.2.0-SNAPSHOT</dt>
            	...
            	<tr>
                    ...
                    <td>
						<ul>
							...
							<!--ibatis2-configuration-START-->
							<li><a href="<c:url value='/ibatis2MovieFinder.do?method=list'/>">iBatis2 0.0.5-SNAPSHOT</a></li>
							<!--ibatis2-configuration-END-->
                        </ul>
                    </td>
                </tr>
            </table>
