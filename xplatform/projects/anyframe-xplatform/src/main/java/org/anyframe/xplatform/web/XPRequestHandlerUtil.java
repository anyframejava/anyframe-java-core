...
public class XPRequestHandlerUtil {
	...
	/**
	 * Get DataSet as List of Map contains information about a row type.
	 * Key of the Map object for the row Type is "rowType". 
	 * 
	 * @param dataSetName
	...
	/**
	 * Get DataSet as Map contains three List Objects.
	 * Key of the Map object for the inserted rows is "insert".
	 * Key of the Map object for the updated rows is "update".
	 * Key of the Map object for the deleted rows is "delete".
	 * 
	 * @param dataSetName
	 * 			Name of DataSet to get
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> getDataSetAsListMap(String dataSetName)
			throws Exception {
		return XPDataSetMapper.convertDataSetToListMap(inDl.get(dataSetName));
	}

	/**
	 * Get DataSet as Map contains three List<Map<String, Object>> Objects.
	 * Key of the Map object for the inserted rows is "insert".
	 * Key of the Map object for the updated rows is "update".
	 * Key of the Map object for the deleted rows is "delete".
	 * 
	...
	/**
	 * Get DataSet As Map contains three List<VO> Objects.
	 * Key of the Map object for the inserted rows is "insert".
	 * Key of the Map object for the updated rows is "update".
	 * Key of the Map object for the deleted rows is "delete".
	 * 
	...
	public Map<String, Object> getDataSetAsVoList(String dataSetName,
			Class<? extends Object> voClazz) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void setVoListToDataSetListWithCheck(String dataSetName, List<Object> voList)
	throws Exception {
		this.outDl.add(XPDataSetMapper.convertVoListToDataset(dataSetName,
				voList, true));
	}
	 ...
	 * @throws Exception
	 */
	public void setVoToVariableList(Object vo) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void addVariableListValue(String key, Object value) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void setMapToVariableList(Map<String, Object> map) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void setResultMsg(int errorCode, String message) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void sendData(int errorCode, String message) throws Exception {
	...
	private void addVariableList(VariableList vl) throws Exception {
		List keyList = vl.keyList();
