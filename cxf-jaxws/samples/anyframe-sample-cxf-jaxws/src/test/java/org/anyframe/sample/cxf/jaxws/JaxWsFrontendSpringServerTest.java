 ...
 * <br>
 * [Description] : This TestCase defines scenarios to test Movie Web Service function implemented based on Spring 
 * 				   by using JAX-WS frontend out of two frontend models(Simple/JAX-WS)at Apache CXF. 
 * <br>
 * [Characteristic]
 * <li>JAX-WS Frontend Use</li>
 * <li>Server implementation: service developed with Spring Bean is easily exposed as Web Service by using <jaxws:endpoint/> Tag 
 * 							  at Spring setup file in the case of using JAX-WS frontend way. 
 ...
 * 							  in the case of implementing Web Container, Spring Container should be set up to start. </li>
 * <br>
 * [Assumption]
...
public class JaxWsFrontendSpringServerTest extends ServerRunner {
    ...
    /**
     * [Flow #-3] Positive Case : Movie whose I.D. IS “001” is searched. 
     * @throws Exception
     *         throws exception which is from service
     */  
	@Test
    ...
    /**
     * [Flow #-5] Positive Case : The existing Movie information whose I.D. is “002” modified. 
     * @throws Exception
     *         throws exception which is from service
     */    
	@Test
