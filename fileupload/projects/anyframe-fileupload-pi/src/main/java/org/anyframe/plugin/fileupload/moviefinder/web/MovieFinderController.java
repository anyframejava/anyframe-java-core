...
import org.anyframe.plugin.fileupload.moviefinder.service.MovieFinder;
 ...
 * @author Sooyeon Park
 */
@Controller("fileUploadMovieFinderController")
@RequestMapping("/fileUploadMovieFinder.do")
public class MovieFinderController {

	@Inject
	@Named("fileUploadMovieFinder")
	...
	public String list(
		...
		return "fileupload/moviefinder/movie/list";
	}
}
