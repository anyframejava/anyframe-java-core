...
public class FileMeta implements Serializable {
	...
	public FileMeta(long nSize, String name) {
		this.size = nSize;
		this.orgfname = name;
	...
	public void setSize(long nSize) { this.size = nSize; }
	
	public String getName() { return this.fname; }
	public void setName(String name) { this.orgfname = name; this.fname = getFileNameOnly(name); }
	
	public String getOrgName() { return this.orgfname; }
