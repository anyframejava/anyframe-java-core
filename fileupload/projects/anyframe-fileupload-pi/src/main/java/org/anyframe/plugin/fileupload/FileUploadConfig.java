...
public class FileUploadConfig implements Serializable {
	...
	public FileUploadConfig(String configPath) 
	{
	...
	private void loadConfigFile(String path) throws MissingResourceException
	{
		...
		while( itor.hasMoreElements() ) {
			...
			if ( KEY_DISK_PATH.toLowerCase().equals( chkKey.toLowerCase() ) ||
				 COMMON_TEMP_PATH.toLowerCase().equals( chkKey.toLowerCase() ) ||
				 COMMON_FILE_MAXSIZE.toLowerCase().equals( chkKey.toLowerCase() )
				) {
