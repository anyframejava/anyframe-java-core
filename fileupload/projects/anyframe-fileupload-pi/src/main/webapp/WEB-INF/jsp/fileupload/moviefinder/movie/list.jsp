...
<script type="text/javascript">
	function fncCreateMovieView() {
		document.location.href="<c:url value='/fileUploadMovie.do?method=createView'/>";
	}	
	function fncSearchMovie(arg) {
	   	document.searchForm.action="<c:url value='/fileUploadMovieFinder.do?method=list'/>";
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                        ...
	                        <td><a class="linkClass" href="${ctx}/fileUploadMovie.do?method=get&movieId=${movie.movieId}">${movie.title}</a></td>
