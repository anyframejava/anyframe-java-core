...
CREATE MEMORY TABLE FILEUPLOAD_ATTACHED(REF_ID VARCHAR(50) NOT NULL,ID VARCHAR(50) NOT NULL,NAME VARCHAR(255),FILE_SIZE NUMERIC(10),CONSTRAINT PK_FILEUPLOAD_ATTACHED PRIMARY KEY(REF_ID,ID))
