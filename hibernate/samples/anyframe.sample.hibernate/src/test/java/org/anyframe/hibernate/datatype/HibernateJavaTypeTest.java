...
public class HibernateJavaTypeTest extends
	...
	public void testInsertJavaDataType() {
		...
		assertNotNull(javaDataType);
		assertEquals(source.getIntType(), javaDataType.getIntType());
		assertEquals(source.getLongType(), javaDataType.getLongType());
		assertEquals(source.getShortType(), javaDataType.getShortType());
		assertEquals(new Float(source.getFloatType()), new Float(javaDataType
				.getFloatType()));
		assertEquals(new Double(source.getDoubleType()), new Double(
				javaDataType.getDoubleType()));
		assertEquals(source.getBigDecimalType(), javaDataType
				.getBigDecimalType());
		assertEquals(source.getCharType(), javaDataType.getCharType());
		assertEquals(source.getStringType(), javaDataType.getStringType());
		assertEquals(source.getByteType(), javaDataType.getByteType());
		assertEquals(source.isBooleanType(), javaDataType.isBooleanType());
		assertEquals(source.isYesNoType(), javaDataType.isYesNoType());
		assertEquals(source.isTrueFalseType(), javaDataType.isTrueFalseType());
	}
	...
	public void testUpdateJavaDataType() {
		...
		assertNotNull(javaDataType);
		assertEquals("Hibernate", javaDataType.getStringType());
		assertEquals(false, javaDataType.isYesNoType());
	}
