		...
		<tbody>
			<c:forEach var="movie" items="${movies}">
				<tr class="board" onMouseOver="this.style.backgroundColor='#e4eaff';return true;" onMouseOut="this.style.backgroundColor=''; return true;" >
					<td class="underline">${movie[0].name}</td>
					<td class="underline">
						<a class="linkClass" href="${ctx}/hibernateMovie.do?method=get&movieId=${movie[1].movieId}">${movie[1].title}</a>
					</td>
					<td align="left">${movie[1].director}</td>
					<td align="left">${movie[1].actors}</td>

					<td align="center">${movie[1].ticketPrice}</td>
					<td align="center">${movie[1].releaseDate}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
