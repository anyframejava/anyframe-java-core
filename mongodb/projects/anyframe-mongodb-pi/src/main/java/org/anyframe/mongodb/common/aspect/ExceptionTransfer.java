 ...
 */
package org.anyframe.mongodb.common.aspect;

import java.util.Locale;

import javax.inject.Inject;

import org.anyframe.mongodb.common.MovieFinderException;
...
public class ExceptionTransfer {
	...
	@AfterThrowing(pointcut = "execution(* org.anyframe.mongodb..*Impl.*(..)) "
