 ...
 */
package org.anyframe.plugin.jce.moviefinder.web;
...
import org.anyframe.plugin.jce.moviefinder.service.GenreService;
import org.anyframe.plugin.jce.moviefinder.service.MovieService;
 ...
 * @author Sooyeon Park
 */
@Controller("jceMovieController")
@RequestMapping("/jceMovie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("jceMovieService")
	private MovieService movieService;

	@Inject
	@Named("jceGenreService")
	...
	public String createView(Model model) throws Exception {
		...
		return "jce/moviefinder/movie/form";
	}
	...
	public String create(
		...
		return "redirect:/jceMovieFinder.do?method=list";
	}
