...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/jceMovieFinder.do?method=list'/>">JCE 1.6.1-SNAPSHOT</a></div>
    </div>
    <hr />
...
<script type="text/javascript">
	function fncCreateMovie() {
	    document.movieForm.action="<c:url value='/jceMovie.do?method=create'/>";
	    document.movieForm.submit();
	}
	
	function fncUpdateMovie() {
	    document.movieForm.action="<c:url value='/jceMovie.do?method=update'/>";
	    document.movieForm.submit();
	}
	
	function fncRemoveMovie(){	
		if(confirmDelete('movie')) {
		    document.movieForm.action="<c:url value='/jceMovie.do?method=remove'/>";
		    document.movieForm.submit();
		}	    
	}	
</script>    
    <div id="container">
        ...
        <div class="btncontainer_center">
		    <a href="<c:url value='/jceMovieFinder.do?method=list'/>">
