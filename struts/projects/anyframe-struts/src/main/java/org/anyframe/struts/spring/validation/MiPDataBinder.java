...
*/
package org.anyframe.struts.spring.validation;

import org.anyframe.struts.spring.beans.MiPVariableListPropertyValues;
...
public class MiPDataBinder extends DataBinder {
	...
	public void bind(VariableList variableList) {
		MutablePropertyValues mpvs = new MiPVariableListPropertyValues(variableList,convertToCamelCase);
		doBind(mpvs);
	}	
	...
	public void bind(Dataset dataList, int rowNum) {
		MutablePropertyValues mpvs = new MiPVariableListPropertyValues(dataList, rowNum,convertToCamelCase);
		doBind(mpvs);
	}
	/**
	...
	public void bind(Dataset dataList, int rowNum, boolean isDeleted) {
		MutablePropertyValues mpvs = new MiPVariableListPropertyValues(dataList, rowNum, isDeleted, convertToCamelCase);
		doBind(mpvs);
	}
}
