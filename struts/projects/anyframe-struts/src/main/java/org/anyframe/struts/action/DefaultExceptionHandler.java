...
public class DefaultExceptionHandler extends ExceptionHandler {
    ...
    public ActionForward execute(Exception ex, ExceptionConfig ae,
        ...
        try {
            if (ex instanceof BaseException) {
                ...
                storeException(request, baseEx.getMessageKey(), message,
                        forward, ae.getScope());
                ...
                storeException(request, message.getKey(), message, forward, ae
                        .getScope());
            }
    ...
    protected void storeException(HttpServletRequest request, String property,
            ActionMessage message, ActionForward forward, String scope) {
