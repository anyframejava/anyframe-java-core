...
public class MovieDao extends QueryServiceDaoSupport {
	...
	public void create(Movie movie) {
		...
		super.create("createStrutsMovie", movie);
	}

	public void remove(String movieId) {
		Movie movie = new Movie();
		movie.setMovieId(movieId);
		super.remove("removeStrutsMovie", movie);
	}

	public void update(Movie movie) {
		update("updateStrutsMovie", movie);
	}

	public Movie get(String movieId) {
		Movie movie = new Movie();
		movie.setMovieId(movieId);
		return super.findByPk("findStrutsMovieByPk", movie);
	}

	public Page getPagingList(Movie movie, int pageIndex) {
		return super.findListWithPaging("findStrutsMovieList", movie, pageIndex,
				pageSize, pageUnit);
	}
}
