 ...
 */
package org.anyframe.archetype.common.aspect;
...
import org.anyframe.archetype.common.MovieFinderException;
...
public class ExceptionTransfer {
	...
	@Pointcut("execution(* org.anyframe.archetype..*Impl.*(..)) || execution(* org.anyframe.mip.query..*MiPServiceImpl.*(..))")
