...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/wsMovieFinder.do'/>">Websocket 1.0.1-SNAPSHOT</a></div>
    </div>
    <hr />
<script type="text/javascript" src="<c:url value='/sample/javascript/CommonScript.js'/>"></script>
<script type="text/javascript" src="<c:url value='/websocket/jquery/js/jquery-1.9.0.min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/websocket/jquery/js/jquery.jqGrid.src.js'/>"></script>
<script type="text/javascript">
	...
	var protocol = "ws";
	var url = protocol + "://" + window.location.host + "<c:url value='/_websocket_/getWebSocketMovieList.do'/>";
	var ws = null;
