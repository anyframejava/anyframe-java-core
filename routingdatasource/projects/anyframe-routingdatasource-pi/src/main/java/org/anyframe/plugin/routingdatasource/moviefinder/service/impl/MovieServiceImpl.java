 ...
 * @author Youngmin Jo
 */
@Service("routingDataSourceMovieService")
@Transactional(value = "txManager2", rollbackFor = { Exception.class }, propagation = Propagation.REQUIRED)
public class MovieServiceImpl implements MovieService {

	@Inject
	@Named("routingDataSourceMovieDao")
