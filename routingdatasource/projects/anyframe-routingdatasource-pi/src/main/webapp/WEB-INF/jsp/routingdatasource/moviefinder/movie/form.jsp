...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/routingDataSourceMovieFinder.do?method=list'/>">RoutingDataSource 1.0.5-SNAPSHOT</a></div>
    </div>
    <hr />
...
<script type="text/javascript">
	function fncCreateMovie() {
		document.movieForm.action="<c:url value='/routingDataSourceMovie.do?method=create'/>";
		document.movieForm.submit();
	}
	
	function fncUpdateMovie() {
		document.movieForm.action="<c:url value='/routingDataSourceMovie.do?method=update'/>";
		document.movieForm.submit();
	}
	
	function fncRemoveMovie(){	
		if(confirmDelete('movie')) {
			document.movieForm.action="<c:url value='/routingDataSourceMovie.do?method=remove'/>";
			document.movieForm.submit();
		}
	}
</script>
    ...
    <div id="container">
			...
			<form:hidden path="movieId" />
      		...
      		<table summary="This table shows detail information about genre, title, director, actors, runtime, release date, ticket price of the movie">
                ...
                <tbody>
                    ...
                    <tr>
                    	<th><label for="theater"><spring:message code="movie.theater" />&nbsp;*</label></th>
						<td><input type="text" name="theater" value="${theater}" readonly="readonly" /></td>
					</tr>
                    <tr>
        ...
        <div class="btncontainer_center">
		    <a href="<c:url value='/routingDataSourceMovieFinder.do?method=list'/>">
