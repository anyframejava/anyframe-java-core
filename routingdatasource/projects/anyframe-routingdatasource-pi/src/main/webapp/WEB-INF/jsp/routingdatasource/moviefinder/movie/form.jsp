...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/routingDataSourceMovieFinder.do?method=list'/>">RoutingDataSource 1.0.3</a></div>
    </div>
    <hr />
