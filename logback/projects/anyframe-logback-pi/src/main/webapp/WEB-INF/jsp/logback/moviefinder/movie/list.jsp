...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/logbackLoginView.do'/>">Logback 1.0.1.RC1</a></div>
    </div>
    <hr />
<script type="text/javascript" src="<c:url value='/sample/javascript/CommonScript.js'/>"></script>    
<script type="text/javascript">
		function fncCreateMovieView() {
			document.location.href="<c:url value='/logbackMovie.do?method=createView'/>";
		}	
		function fncSearchMovie(arg) {
		   	document.searchForm.action="<c:url value='/logbackMovieFinder.do?method=list'/>";
		   	document.searchForm.submit();						
		}		
		function fncLogout() {
		   	document.searchForm.action="<c:url value='/logbackLogout.do'/>";
		   	document.searchForm.submit();						
		}	
</script>
  	<div id="container">
                ...
                <tbody>
                	<c:forEach var="movie" items="${movies}">
	                	<tr>
	                        ...
	                        <td><a class="linkClass" href="${ctx}/logbackMovie.do?method=get&amp;movieId=${movie.movieId}">${movie.title}</a></td>
