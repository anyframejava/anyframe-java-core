...
import org.anyframe.plugin.logback.moviefinder.service.MovieFinder;
 ...
 * @author Sooyeon Park
 */
@Controller("logbackMovieFinderController")
@RequestMapping("/logbackMovieFinder.do")
public class MovieFinderController {

	@Inject
	@Named("logbackMovieFinder")
	...
	public String list(
		...
		return "logback/moviefinder/movie/list";
	}
}
