 ...
 */
package org.anyframe.plugin.logback.moviefinder.web;
...
import org.anyframe.plugin.logback.domain.Genre;
import org.anyframe.plugin.logback.domain.Movie;
import org.anyframe.plugin.logback.moviefinder.service.GenreService;
import org.anyframe.plugin.logback.moviefinder.service.MovieService;
 ...
 * @author Sooyeon Park
 */
@Controller("logbackMovieController")
@RequestMapping("/logbackMovie.do")
@SessionAttributes(types = Movie.class)
public class MovieController {

	@Inject
	@Named("logbackMovieService")
	private MovieService movieService;

	@Inject
	@Named("logbackGenreService")
