package org.anyframe.logback.appender.socket.server;
/**
...
public class SimpleSocketServer extends Thread {
	...
	public static void main(String argv[]) throws Exception {
		...
		prop.load(new FileInputStream("src/test/resources/logback-socket.properties"));

		int port = Integer.parseInt((String)prop.get("serverPort"));
		
		String configFile = (String)prop.get("configFile");
