...
CREATE MEMORY TABLE FLEX_BOARD(POST_ID VARCHAR(16) NOT NULL,TITLE VARCHAR(50) NOT NULL,CONTENTS VARCHAR(255),REG_ID VARCHAR(20),REG_DATE VARCHAR(10),COMMUNITY_ID VARCHAR(16) NOT NULL,CONSTRAINT PK_FLEX_BOARD PRIMARY KEY(POST_ID));
CREATE MEMORY TABLE FLEX_CATEGORY(CATEGORY_ID VARCHAR(16) NOT NULL,CATEGORY_NAME VARCHAR(50) NOT NULL,CATEGORY_DESC VARCHAR(100),REG_DATE VARCHAR(10),CONSTRAINT PK_FLEX_CATEGORY PRIMARY KEY(CATEGORY_ID));
CREATE MEMORY TABLE FLEX_COMMUNITY(COMMUNITY_ID VARCHAR(16) NOT NULL,COMMUNITY_NAME VARCHAR(50) NOT NULL,COMMUNITY_DESC VARCHAR(100),CATEGORY_ID VARCHAR(16),REG_ID VARCHAR(20),REG_DATE VARCHAR(10),CONSTRAINT PK_FLEX_COMMUNITY PRIMARY KEY(COMMUNITY_ID),CONSTRAINT FK_FLEX_CATEGORY FOREIGN KEY(CATEGORY_ID) REFERENCES FLEX_CATEGORY(CATEGORY_ID));
CREATE MEMORY TABLE FLEX_DEPT(DEPT_ID VARCHAR(16) NOT NULL,DEPT_NAME VARCHAR(20) NOT NULL,DEPT_LEVEL VARCHAR(1),DEPT_DESC VARCHAR(100),PARENT_DEPT VARCHAR(16),CONSTRAINT PK_FLEX_DEPT PRIMARY KEY(DEPT_ID));
CREATE MEMORY TABLE FLEX_USER(USER_NAME VARCHAR(20) NOT NULL,EN_NAME VARCHAR(20),COMP_PHONE VARCHAR(20),PHONE VARCHAR(20),CELL_PHONE VARCHAR(20),COMPANY VARCHAR(20),JOB_POSITION VARCHAR(20),ASSIGNMENT VARCHAR(20),OFFICER_YN VARCHAR(1),FAX VARCHAR(20),ZIP_CODE VARCHAR(10),ADDRESS VARCHAR(100),COMP_ZIP_CODE VARCHAR(10),COMP_ADDRESS VARCHAR(100),EMAIL VARCHAR(30),USER_ID VARCHAR(16) NOT NULL,DEPT_ID VARCHAR(16) NOT NULL,PASSWORD VARCHAR(16) NOT NULL,AUTHORITY VARCHAR(20),CONSTRAINT PK_FLEX_USER PRIMARY KEY(USER_ID),CONSTRAINT FK_FLEX_DEPT FOREIGN KEY(DEPT_ID) REFERENCES FLEX_DEPT(DEPT_ID));
CREATE MEMORY TABLE FLEX_GENRE(GENRE_ID VARCHAR(5) NOT NULL,NAME VARCHAR(50) NOT NULL,CONSTRAINT PK_FLEX_GENRE PRIMARY KEY(GENRE_ID));
CREATE MEMORY TABLE FLEX_MOVIE(MOVIE_ID VARCHAR(50) NOT NULL,GENRE_ID VARCHAR(5) NOT NULL,TITLE VARCHAR(50) NOT NULL,DIRECTOR VARCHAR(50) NOT NULL,ACTORS VARCHAR(100) NOT NULL,RUNTIME NUMERIC(3),RELEASE_DATE DATE,TICKET_PRICE NUMERIC(6,2),POSTER_FILE VARCHAR(1000),NOW_PLAYING CHARACTER(1),FILE_REF_ID VARCHAR(50),CONSTRAINT PK_FLEX_MOVIE PRIMARY KEY(MOVIE_ID),CONSTRAINT FK_FLEX_MOVIE FOREIGN KEY(GENRE_ID) REFERENCES FLEX_GENRE(GENRE_ID));
CREATE MEMORY TABLE FLEX_ATTACHED(ID VARCHAR(50) NOT NULL,NAME VARCHAR(255),FILE_SIZE NUMERIC(15),REF_ID VARCHAR(50) NOT NULL,CONSTRAINT PK_FLEX_ATTACHED PRIMARY KEY(ID));
CREATE MEMORY TABLE FLEX_INDUSTRY(ID VARCHAR(16) NOT NULL PRIMARY KEY,NAME VARCHAR(50));
CREATE MEMORY TABLE FLEX_COMPANY(ID VARCHAR(16) NOT NULL PRIMARY KEY,NAME VARCHAR(50),ADDRESS VARCHAR(50),CITY VARCHAR(50),STATE VARCHAR(20),ZIP VARCHAR(20),PHONE VARCHAR(50),INDUSTRY_ID INTEGER);
CREATE MEMORY TABLE FLEX_PRODUCT(PRODUCT_ID VARCHAR(16) NOT NULL PRIMARY KEY,NAME VARCHAR(40),CATEGORY VARCHAR(40),IMAGE VARCHAR(40),PRICE DOUBLE,DESCRIPTION VARCHAR(255),QTY_IN_STOCK INTEGER);
CREATE MEMORY TABLE FLEX_CONTACT(CONTACT_ID VARCHAR(16) NOT NULL PRIMARY KEY,FIRST_NAME VARCHAR(40),LAST_NAME VARCHAR(40),ADDRESS VARCHAR(40),CITY VARCHAR(40),STATE CHARACTER(5),ZIP VARCHAR(10),PHONE VARCHAR(40),EMAIL VARCHAR(40));
...
INSERT INTO FLEX_BOARD VALUES('POST-00006','데이타베이스 테이블에 관한 질문입니다.','제가 한 테이블에 모든게시판의 리스트를 넣어놨습니다..','hong80','2009/12/25','COMMUNITY-0002');
...
INSERT INTO FLEX_USER VALUES('홍길동','Hong Gildong','02-6456-1223','02-7484-0912','010-9911-0033','삼성SDS','책임','어플리케이션개발','N','02-6481-0091','463-180','경기도 성남시 분당구 구미동','463-810','경기도 성남시 분당구','gildong@naver.com','hong80','DEPT-0007','test123','ROLE_USER');
