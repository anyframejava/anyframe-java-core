...
FLEX_CATEGORY_ID_SEQ 	INTEGER	NOT NULL,
FLEX_COMMUNITY_ID_SEQ	INTEGER NOT NULL,
FLEX_POST_ID_SEQ	INTEGER NOT NULL,
FLEX_USER_ID_SEQ	INTEGER NOT NULL,
FLEX_INDUSTRY_ID_SEQ 	INTEGER	NOT NULL,
FLEX_COMPANY_ID_SEQ	INTEGER NOT NULL,
FLEX_PRODUCT_SEQ	INTEGER NOT NULL,
FLEX_CONTACT_ID_SEQ	INTEGER NOT NULL);
INSERT INTO MYSQL_SEQ VALUES (1234, 1234, 1234, 1234, 1234, 1234, 1234, 1234);

--SET GLOBAL log_bin_trust_function_creators = 1;
--DELIMITER $$
--CREATE FUNCTION FLEX_CATEGORY_ID_SEQ_NEXT_VALUE() RETURNS INT(4)
--BEGIN
--	DECLARE NEXT_VALUE INT(4) ;
--	UPDATE MYSQL_SEQ SET FLEX_CATEGORY_ID_SEQ = FLEX_CATEGORY_ID_SEQ + 1;
--        SELECT FLEX_CATEGORY_ID_SEQ INTO NEXT_VALUE FROM MYSQL_SEQ;
--        RETURN NEXT_VALUE;
--END$$
--CREATE FUNCTION FLEX_COMMUNITY_ID_SEQ_NEXT_VALUE() RETURNS INT(4)
--BEGIN
--	DECLARE NEXT_VALUE INT(4) ;
--	UPDATE MYSQL_SEQ SET FLEX_COMMUNITY_ID_SEQ = FLEX_COMMUNITY_ID_SEQ + 1;
--        SELECT FLEX_COMMUNITY_ID_SEQ INTO NEXT_VALUE FROM MYSQL_SEQ;
--        RETURN NEXT_VALUE;
--END$$
--CREATE FUNCTION FLEX_POST_ID_SEQ_NEXT_VALUE() RETURNS INT(4)
--BEGIN
--	DECLARE NEXT_VALUE INT(4) ;
--	UPDATE MYSQL_SEQ SET FLEX_POST_ID_SEQ = FLEX_POST_ID_SEQ + 1;
--        SELECT FLEX_POST_ID_SEQ INTO NEXT_VALUE FROM MYSQL_SEQ;
--        RETURN NEXT_VALUE;
--END$$
--CREATE FUNCTION FLEX_USER_ID_SEQ_NEXT_VALUE() RETURNS INT(4)
--BEGIN
--	DECLARE NEXT_VALUE INT(4) ;
--	UPDATE MYSQL_SEQ SET FLEX_USER_ID_SEQ = FLEX_USER_ID_SEQ + 1;
--        SELECT FLEX_USER_ID_SEQ INTO NEXT_VALUE FROM MYSQL_SEQ;
--        RETURN NEXT_VALUE;
--END$$
--DELIMITER ;
...
CREATE TABLE FLEX_PRODUCT(PRODUCT_ID VARCHAR(16) NOT NULL PRIMARY KEY,NAME VARCHAR(40),CATEGORY VARCHAR(40),IMAGE VARCHAR(40),PRICE DOUBLE,DESCRIPTION VARCHAR(255),QTY_IN_STOCK INTEGER);
