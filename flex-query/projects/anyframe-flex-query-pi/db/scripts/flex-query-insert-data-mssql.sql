CREATE TABLE FLEX_BOARD(POST_ID VARCHAR(16) NOT NULL,TITLE VARCHAR(50) NOT NULL,CONTENTS VARCHAR(255),REG_ID VARCHAR(20),REG_DATE VARCHAR(10),COMMUNITY_ID VARCHAR(16) NOT NULL,POST_ID_SEQ  INT IDENTITY(1,1),CONSTRAINT PK_FLEX_BOARD PRIMARY KEY(POST_ID));
CREATE TABLE FLEX_CATEGORY(CATEGORY_ID VARCHAR(16) NOT NULL,CATEGORY_NAME VARCHAR(50) NOT NULL,CATEGORY_DESC VARCHAR(100),REG_DATE VARCHAR(10),CATEGORY_ID_SEQ  INT IDENTITY(1,1),CONSTRAINT PK_FLEX_CATEGORY PRIMARY KEY(CATEGORY_ID));
...
CREATE TABLE FLEX_MOVIE(MOVIE_ID VARCHAR(50) NOT NULL,GENRE_ID VARCHAR(5) NOT NULL,TITLE VARCHAR(50) NOT NULL,DIRECTOR VARCHAR(50) NOT NULL,ACTORS VARCHAR(100) NOT NULL,RUNTIME DECIMAL(3),RELEASE_DATE DATETIME,TICKET_PRICE DECIMAL(6,2),POSTER_FILE VARCHAR(1000),NOW_PLAYING CHAR(1),FILE_REF_ID VARCHAR(50),CONSTRAINT PK_FLEX_MOVIE PRIMARY KEY(MOVIE_ID),CONSTRAINT FK_FLEX_MOVIE FOREIGN KEY(GENRE_ID) REFERENCES FLEX_GENRE(GENRE_ID));
CREATE TABLE FLEX_ATTACHED(ID VARCHAR(50) NOT NULL,NAME VARCHAR(255),FILE_SIZE DECIMAL(15),REF_ID VARCHAR(50) NOT NULL,CONSTRAINT PK_FLEX_ATTACHED PRIMARY KEY(ID));
CREATE TABLE FLEX_INDUSTRY(ID VARCHAR(16) NOT NULL PRIMARY KEY,NAME VARCHAR(50));
CREATE TABLE FLEX_COMPANY
(
       ...
       CONSTRAINT PK_FLEX_COMPANY PRIMARY KEY(ID)
);

CREATE TABLE FLEX_PRODUCT
(
       ...
       QTY_IN_STOCK INT,
       CONSTRAINT PK_FLEX_PRODUCT PRIMARY KEY(PRODUCT_ID));
CREATE TABLE FLEX_CONTACT
(
       ...
       PHONE VARCHAR(40),
       EMAIL VARCHAR(40),
       CONTACT_ID_SEQ  INT IDENTITY(1,1),
       CONSTRAINT PK_FLEX_CONTACT PRIMARY KEY(CONTACT_ID)
);
