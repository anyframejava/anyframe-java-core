 ...
 * <br>
 * [Description] : Spring 설정을 이용한 Hessian 기반의 Movie 서비스를 구현하여 서비스의 기능을 테스트할 수 있는
 ...
 * 제공하는 org.springframework.remoting.caucho.HessianServiceExporter 클래스를 이용하여 손쉽게
 * 일반 Spring Bean으로 작성된 서비스를 Burlap Service로 노출, Spring MVC를 사용하여 HTTP 기반 Burlap
 * 컨트롤러 설정</li> <li>클라이언트 구현: Spring에서 제공하는
 * org.springframework.remoting.caucho.HessianProxyFactoryBean 클래스 이용</li> <br>
