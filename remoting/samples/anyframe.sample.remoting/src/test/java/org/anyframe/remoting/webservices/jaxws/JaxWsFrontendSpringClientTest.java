 ...
 *                 Spring 기반으로 구현한 Movie Web Service의 기능을 Spring TestCase를 이용하여
 *                 테스트할 수 있는 시나리오들을 정의한 TestCase이다.
 * <br>
 * [Characteristic]
...
public class JaxWsFrontendSpringClientTest extends RemotingSpringTestCase {
    ...
    protected String[] getConfigLocations() {
        ...
        return new String[] {"classpath*:/webservices/jaxws/client/context-movie-client.xml" };
    }
    ...
    public void onSetUpServer() throws Exception {
        ...
        serverInfo
            .setWarpath("src/test/resources/webservices/jaxws/server/webapp");
