...
@WebServiceClient(name = "MovieServiceAsynchService", wsdlLocation = "file:src/test/resources/webservices/asynch/wsdl/MovieServiceAsynchService.wsdl", targetNamespace = "http://asynch.jaxws.movie.sample.anyframe/asynch_soap_http")
public class MovieServiceAsynchService extends Service {
    ...
    static {
        ...
        try {
            url =
                new URL(
                    "file:src/test/resources/webservices/asynch/wsdl/MovieServiceAsynchService.wsdl");
        } catch (MalformedURLException e) {
            System.err
                .println("Can not initialize the default wsdl from file:src/test/resources/webservices/asynch/wsdl/MovieServiceAsynchService.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
