...
/**
 * TestCase Name : SimpleFrontendSpringSupportFactoryTest <br>
 * <br>
 ...
 *                 이때, 클라이언트에서 org.apache.cxf.frontend.ClientProxyFactoryBean class를 Spring 설정 XML 파일에 등록하여
 *                 Movie Web Service에 접근하도록 한다.
 * <br>
 * [Characteristic]
 ...
 * <li>클라이언트 구현: Simple frontend 방식 이용 시 Spring 설정 XML 파일에 ClientProxyFactoryBean class를 Spring Bean으로 
 *                    등록하여 Movie Web Service를 접근한다.</li>               
 * <br>
 * [Assumption]
...
public class SimpleFrontendSpringSupportFactoryTest extends RemotingSpringTestCase {
    ...
    protected String[] getConfigLocations() {
        return new String[] {"classpath*:/webservices/springsupport/client/context-movie-client-factory.xml" };
    }
    ...
    public void testFindMovieListAll() throws Exception {
        ...
        List<Movie> movieList = movieServiceFactory.findMovieListAll();
    ...
    public void testFindMovieMapAll() throws Exception {
        ...
        Map<String, Movie> movieMap = movieServiceFactory.findMovieMapAll();
    ...
    public void testCreateMovie() throws Exception {
        ...
        assertEquals(2, movieServiceFactory.findMovieListAll().size());

        // 2. create new movie
        movieServiceFactory.createMovie(new Movie("003", "Life Is Beautiful",
            "Roberto Benigni"));

        // 3. check the new movie list count
        assertEquals(3, movieServiceFactory.findMovieListAll().size());

        // 4. check the new movie information
        Movie movie = movieServiceFactory.findMovie("003");
    ...
    public void testUpdateMovie() throws Exception {
        // 1. update movie
        movieServiceFactory.updateMovie(new Movie("002", "Life Is Wonderful",
            "Roberto"));

        // 2. find updated movie
        Movie movie = movieServiceFactory.findMovie("002");
    ...
    public void testRemoveMovie() throws Exception {
        ...
        // 2. remove the movie
        movieServiceFactory.removeMovie(movie);

        // 3. check the removed movie info
        assertNull(movieServiceFactory.findMovie("002"));
    }
}
