...
@WebService(targetNamespace = "http://org.anyframe.sample.remoting.movie.restful.httpbinding.jra")
public interface MovieService {
    ...
    @WebResult(name = "Movies",targetNamespace = "http://org.anyframe.sample.remoting.movie.restful.httpbinding.jra")
    public Movies findMovieListAll() throws Exception;

    @Get
    @HttpResource(location = "/movies/{movieId}")
    @WebResult(name = "Movie",targetNamespace = "http://org.anyframe.sample.remoting.movie.restful.httpbinding.jra")
    ...
    @Put
    @HttpResource(location = "/movies/{movieId}")
    public void updateMovie(@WebParam(name = "Movie")
    Movie movie) throws Exception;
