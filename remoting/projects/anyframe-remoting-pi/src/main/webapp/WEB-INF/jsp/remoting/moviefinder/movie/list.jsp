...
<script type="text/javascript">
		function fncCreateMovieView() {
			document.location.href="<c:url value='/remotingMovieExporter.do?method=createView'/>";
		}	
		function fncSearchMovie(arg) {
		   	document.searchForm.action="<c:url value='/remotingMovieFinderExporter.do?method=list'/>";
               ...
               <tbody>
               	<c:forEach var="movie" items="${movies}">
                	<tr>
                        ...
                        <td><a class="linkClass" href="${ctx}/remotingMovieExporter.do?method=get&amp;movieId=${movie.movieId}">${movie.title}</a></td>
