...
import org.anyframe.plugin.remoting.moviefinder.service.MovieFinder;
...
@RequestMapping("/remotingMovieFinderExporter.do")
public class MovieFinderController {
	...
	public String list(
		...
		return "remoting/moviefinder/movie/list";
	}
}
