...
import org.anyframe.plugin.remoting.moviefinder.service.GenreService;
import org.anyframe.plugin.remoting.moviefinder.service.MovieService;
 ...
 * @author Sujeong Lee
 */
@Controller("remotingMovieController")
...
public class MovieController {
	...
	public String create(@Valid Movie movie, BindingResult results, SessionStatus status,
		...
		return "redirect:/remotingMovieFinderExporter.do?method=list";
	}
