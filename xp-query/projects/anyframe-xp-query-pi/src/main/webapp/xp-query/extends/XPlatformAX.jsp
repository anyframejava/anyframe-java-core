...
var sAdl = Server_Path + "<c:url value='/xp-query/extends/'/>" + "SampleApplication.xadl";
var bOnError = false;
...
function fn_onload()
{
	...
	// 전역 변수로 form url 주소를 넘긴다.
	XLauncher.globalvalue = "gvPageURL:g=" +  "<%= xpid %>";
