...
public class VariableListPropertyValues extends MutablePropertyValues {
	 ...
	 */
	public VariableListPropertyValues(VariableList variableList, boolean convertToCamelCase){
	 ...
	 */
	public VariableListPropertyValues(DataSet dataList, int rowNum, boolean convertToCamelCase){
	 ...
	 */
	public VariableListPropertyValues(DataSet dataList, int rowNum, boolean isDeleted, boolean convertToCamelCase){
