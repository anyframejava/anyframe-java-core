...
/**
 * For using XPLATFORM data, request is transformed XPRequestHandler class.
 * 
 * @author Youngmin Jo
 *
 */
public class XPRequestHandler {
	 ...
	 */
	public XPRequestHandler(HttpServletRequest request,  String contentType, String charset)
			throws PlatformException {
	...
	public XPRequestHandler(HttpServletRequest request)
			throws PlatformException {
