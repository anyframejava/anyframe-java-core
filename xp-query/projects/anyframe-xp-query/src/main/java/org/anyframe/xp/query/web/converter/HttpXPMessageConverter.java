 ...
 */
package org.anyframe.xp.query.web.converter;
...
/**
 * Implementation class of {@link HttpMessageConverter} for sending/receiving to XPLATFORM UI.
 * 
 * @author Youngmin Jo
 */
public class HttpXPMessageConverter implements HttpMessageConverter<Object> {
	...
	protected Logger logger = LoggerFactory
			.getLogger(HttpXPMessageConverter.class);
	...
	public boolean canRead(Class<?> clazz, MediaType mediaType) {
		if (isReadable(mediaType) || XPRequestHandler.class.equals(clazz)) {
			return true;
		}
		return false;
	}
	...
	public boolean canWrite(Class<?> clazz, MediaType mediaType) {
		if (isWritable(mediaType) || XPResponseHandler.class.equals(clazz)) {
			return true;
		}
		return false;
	}
