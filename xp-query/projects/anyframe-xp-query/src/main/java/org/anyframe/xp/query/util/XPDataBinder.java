...
public class XPDataBinder extends DataBinder {
	...
	public void bind(VariableList variableList) {
		MutablePropertyValues mpvs = new VariableListPropertyValues(variableList,convertToCamelCase);
		doBind(mpvs);
	}	
	...
	public void bind(DataSet dataList, int rowNum) {
		MutablePropertyValues mpvs = new VariableListPropertyValues(dataList, rowNum,convertToCamelCase);
		doBind(mpvs);
	}
	/**
	...
	public void bind(DataSet dataList, int rowNum, boolean isDeleted) {
		MutablePropertyValues mpvs = new VariableListPropertyValues(dataList, rowNum, isDeleted, convertToCamelCase);
		doBind(mpvs);
	}
}
