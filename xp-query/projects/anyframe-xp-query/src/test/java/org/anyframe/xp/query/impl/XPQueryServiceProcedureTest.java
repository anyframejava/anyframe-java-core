...
/**
 * TestCase Name : XPQueryServiceProcedureTest<br>
 * <br>
 * [Description] : BUG로 등록된 [AF-277] 이슈에 대한 처리 결과를 검증한다.<br>
 * Procedure 호출을 위해서 XPQueryService.execute 메소드 호출 시, Out Parameter가 2개 이상인 경우<br>
...
public class XPQueryServiceProcedureTest {
	...
	public void testProcedure() {
		...
		try {
			outDl = xpQueryService.execute("callProcedureTwo", inDs);
		} catch (Exception e) {
			e.printStackTrace();
		}
