...
// * [Main Flow]
// * <ul>
// * <li>#1- Positive Case : AnyframeXPController를 상속 받은 XPController의 process가
// * 호출 되었을 때 AnyframeXPController의 process method에서 HttpRequest로 넘어온 사용자 입력값을
...
//
//    /**
//	 * [Flow #-1] Positive Case : AnyframeXPController를 상속 받은
//	 * XPController의 process가 호출 되었을 때 AnyframeXPController의 process method에서
...
//	 * AnyframeXPController를 extends한 XPController의 operate가 제대로 호출 되고 결과 메세지를
...
//        assertEquals("save successed", controller.outVl.getString("ErrorMsg"));
//    }
//    
//    /**
//	 * [Flow #-3] Positive Case : XPController의 operate method에서 Exception이
...
//	 * 'test_ds'란 아이디의 Dataset으로 변환 한 후 Dataset값과 XPTestVO의 값들을 비교하여
...
//        
//        HashMap hashMap = XPMapper.convertDatasetToListMap( MappingVO.class , ds);
//        
...
//        
//        HashMap hashMap = XPMapper.convertDatasetToListMap( MappingVO.class , ds, true);
//        
//        assertNotNull(hashMap);
//        assertEquals(2, ((ArrayList)hashMap.get("insert")).size());
//        assertEquals(2, ((ArrayList)hashMap.get("update")).size());
...
//        
//        private Log log =
//            LogFactory.getLog(TestXPController.class);
//
