 ...
 */
@Controller("asyncSupportMovieDeferredResultController")
@RequestMapping("/asyncSupportMovieDeferredResult.do")
@SessionAttributes(types = Movie.class)
public class MovieControllerDeferredResult {

	Logger logger = LoggerFactory.getLogger(MovieControllerDeferredResult.class);
	...
	@Autowired
	public MovieControllerDeferredResult(MovieRepository movieRepository) {
	...
	public String createView(Model model) throws Exception {
		...
		return "async-support/moviefinder/deferredMovie/form";
	}
	...
	public String create(@Valid Movie movie, BindingResult results,
		...
		return "redirect:/asyncSupportMovieFinderDeferredResult.do?method=list";
	}
