 ...
 */
@Controller("asyncSupportMovieCallableController")
@RequestMapping("/asyncSupportMovieCallable.do")
@SessionAttributes(types = Movie.class)
public class MovieControllerCallable {

	Logger logger = LoggerFactory.getLogger(MovieControllerCallable.class);
	...
	@Autowired
	public MovieControllerCallable(MovieRepository movieRepository) {
	...
	public String createView(Model model) throws Exception {
		...
		return "async-support/moviefinder/callableMovie/form";
	}
	...
	public String create(@Valid Movie movie, BindingResult results,
		...
		status.setComplete();
		return "redirect:/asyncSupportMovieFinderCallable.do?method=list";
	}
