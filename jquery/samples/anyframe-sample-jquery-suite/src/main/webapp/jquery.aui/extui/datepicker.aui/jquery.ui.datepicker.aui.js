 ...
 *
 * it's merged three opensource libraries into datepicker.aui library.
 * there are jquery.ui.datepicker, jquery.fs.selecter, jquery.fs.scroller.
 * look the below libraries.
 *
 * leave this "@AUI" comment in changes on source.
 *
 */
...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
        ...
        useExtSelect: false //@AUI added on 2013.09.10
	};
...
$.extend(Datepicker.prototype, {
	...
	_updateDatepicker: function(inst) {
        ...
        //@AUI Use External Selecter & Scroller Support
        if (inst.settings.useExtSelect) {

            if (inst.settings.changeMonth)
                selecterFunc(inst.dpDiv.find("select[class='ui-datepicker-month']"));

            if (inst.settings.changeYear)
                selecterFunc(inst.dpDiv.find("select[class='ui-datepicker-year']"));
        }
...
/**
 * @AUI
 * merged selecter & scroller library into datepicer.aui
 */
...
var selecterFunc = (function($) {
    ...
    var pub = {
        ...
        destroy: function() {
            return $(this).each(function(i, input) {
                ...
                //@AUI replaced by ...
                scrollerFunc($selecter.find(".selecter-options"), "destroy");
    ...
    function _build($selectEl, opts) {
        if (!$selectEl.data("selecter")) {
            ...
            //@AUI replaced by ...
            scrollerFunc(opts.$itemsWrapper);
    ...
    function _open(e) {
        ...
        if (!data.$selecter.hasClass("open")) {
            ...
            //@AUI replaced by ...
            scrollerFunc(data.$itemsWrapper, "reset");
        }
    }
    ...
    //@AUI removed to be not allowing public access
    //@AUI define inner-calling wrapper
    ...
    return function($target, method) {
        ...
        if (pub[method]) {
            return pub[method].apply($target, Array.prototype.slice.call(arguments, 2));
        } else if (typeof method === 'object' || !method) {
            return _init.apply($target, Array.prototype.slice.call(arguments, 1));
        }
    };
})(jQuery);         // End of Selecter Plugin
