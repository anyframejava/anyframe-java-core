...
CREATE TABLE JQUERY_ATTACHED(ID VARCHAR(50) NOT NULL,NAME VARCHAR(255),FILE_SIZE DECIMAL(15),REF_ID VARCHAR(50) NOT NULL,CONSTRAINT PK_JQUERY_ATTACHED PRIMARY KEY(ID));
