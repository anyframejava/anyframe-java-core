CREATE MEMORY TABLE JQUERY_BOARD(POST_ID VARCHAR(50) NOT NULL,TITLE VARCHAR(50) NOT NULL,CONTENTS VARCHAR(255),REG_ID VARCHAR(50),REG_DATE VARCHAR(10),COMMUNITY_ID VARCHAR(50) NOT NULL,CONSTRAINT PK_JQUERY_BOARD PRIMARY KEY(POST_ID));
CREATE MEMORY TABLE JQUERY_CATEGORY(CATEGORY_ID VARCHAR(50) NOT NULL,CATEGORY_NAME VARCHAR(50) NOT NULL,CATEGORY_DESC VARCHAR(100),REG_DATE VARCHAR(10),CONSTRAINT PK_JQUERY_CATEGORY PRIMARY KEY(CATEGORY_ID));
...
CREATE MEMORY TABLE JQUERY_ATTACHED(ID VARCHAR(50) NOT NULL,NAME VARCHAR(255),FILE_SIZE NUMERIC(15),REF_ID VARCHAR(50) NOT NULL,CONSTRAINT PK_JQUERY_ATTACHED PRIMARY KEY(ID));
...
INSERT INTO JQUERY_BOARD VALUES('POST-00006','데이타베이스 테이블에 관한 질문입니다.','제가 한 테이블에 모든게시판의 리스트를 넣어놨습니다..','hong80','2009/12/25','COMMUNITY-0002');
