...
/**
 * This DeptDao class is a DAO class to provide dept crud functionality.
 * 
 * @author jonghwan jeong
 */
@Repository("jqueryDeptDao")
public class DeptDao extends QueryServiceDaoSupport {
	...
	public List<Dept> list() throws Exception {
        ...
        return super.findList("findJqueryDeptList", args);
	}

	public Dept get(String deptId) {
		Dept dept = new Dept();
		dept.setDeptId(deptId);
		return super.findByPk("findJqueryDeptByPk", dept);
	}
}
