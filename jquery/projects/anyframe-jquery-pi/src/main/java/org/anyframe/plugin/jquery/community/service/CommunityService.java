...
public interface CommunityService {
	 ...
	 * @throws Exception
	 */
	String create(Community community) throws Exception;
	 ...
	 * @throws Exception
	 */
	int updateCell(Community community) throws Exception;
	 ...
	 * @throws Exception
	 */
	Page getPagingList(Community community) throws Exception;
	
	/**
	 * @return
	 * @throws Exception
	 */
	List<Community> getList() throws Exception;
