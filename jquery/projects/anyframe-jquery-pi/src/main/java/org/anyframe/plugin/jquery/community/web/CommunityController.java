...
public class CommunityController {
	...
	public String get(Model model, Community param) throws Exception {
		Community community = communityService.get(param.getCommunityId());
	...
	public String save(HttpSession session, Model model, Community param) throws Exception {
	...
	public String updateCell(Community param, Model model, 
