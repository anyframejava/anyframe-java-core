...
public class BoardController {
	...
	public static Log logger = LogFactory.getLog(BoardController.class);
	...
	public String create(HttpSession session, @RequestParam(value = "refId") String fileRefId, Board board, Model model, HttpServletRequest request)
			throws Exception {
