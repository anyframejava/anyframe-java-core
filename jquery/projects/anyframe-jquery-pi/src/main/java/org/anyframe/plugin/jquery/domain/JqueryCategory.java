 ...
 * @author Sujeong Lee
 */
public class JqueryCategory extends JqGridVO implements Serializable{
    ...
    private List<JqueryCommunity> children;
	...
	public List<JqueryCommunity> getChildren() {
		return children;
	}
	public void setChildren(List<JqueryCommunity> children) {
