...
public class CategoryController {
	...
	public String gridList(
			...
			Category param, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String save(Category param, Model model) throws Exception{
	...
	public String remove(Category param) throws Exception{
