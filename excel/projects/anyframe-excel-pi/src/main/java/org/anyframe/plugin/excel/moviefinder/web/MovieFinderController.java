 ...
 */
package org.anyframe.plugin.excel.moviefinder.web;
...
import org.anyframe.plugin.excel.moviefinder.service.MovieFinder;
 ...
 * @author Jonghoon Kim
 */
@Controller("excelMovieFinderController")
@RequestMapping("/excelMovieFinder.do")
public class MovieFinderController {
	...
	public String list(
		...
		return "excel/moviefinder/movie/list";
	}
}
