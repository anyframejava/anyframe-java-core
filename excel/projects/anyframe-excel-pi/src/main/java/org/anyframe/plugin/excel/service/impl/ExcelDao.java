...
public class ExcelDao {
	...
	public List getPagingList(String queryId, int pageIndex, Map searchMap) throws Exception{
		return  (List) queryService.find( queryId , convertParams(searchMap) , pageIndex);
	}
