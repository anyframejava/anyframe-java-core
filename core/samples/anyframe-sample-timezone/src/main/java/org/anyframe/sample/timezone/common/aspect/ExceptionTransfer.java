 ...
 */
package org.anyframe.sample.timezone.common.aspect;

import java.util.Locale;

import javax.inject.Inject;

import org.anyframe.sample.timezone.common.MovieFinderException;
...
public class ExceptionTransfer {
	...
	@AfterThrowing(pointcut = "execution(* org.anyframe.sample.timezone..*Impl.*(..)) "
