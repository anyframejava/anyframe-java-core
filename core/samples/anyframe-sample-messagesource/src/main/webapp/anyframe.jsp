        ...
        <div class="itemBox_1">
            ...
            <caption>A list of installed plugins</caption>
            	...
            	<tr>
                    ...
                    <td>
                    	<ul>
                    		<li><a href="<c:url value='/queryMovieFinder.do?method=list'/>">Query 1.5.0.RC1</a></li>
                    		<!--MessageSource-START-->
                            <li><a href="<c:url value='/messageSource.do?method=list'/>">MessageSource Sample - 1.5.0.RC1</a></li>
                            <!--MessageSource-END-->
                        </ul>
                    </td>
                </tr>
