...
import org.anyframe.sample.transaction.moviefinder.config.AppConfig;
...
/**
 * This class is test case class for annotation based declarative Transaction Service with java-config.
 * 
 * @author Heewon Jung
 *
 */
...
public class DeclarativeTransactionManagementConfigWithAnnotationTest {
