 ...
 */
package org.anyframe.sample.genericqualifier.common.aspect;

import java.util.Locale;

import javax.inject.Inject;

import org.anyframe.sample.genericqualifier.common.MovieFinderException;
...
public class ExceptionTransfer {
	...
	@Pointcut("execution(* org.anyframe.sample.genericqualifier..*Impl.*(..))")
