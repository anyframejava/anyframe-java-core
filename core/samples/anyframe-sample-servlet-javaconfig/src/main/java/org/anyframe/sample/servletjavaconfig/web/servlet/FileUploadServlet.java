 ...
 * to implement file upload function.
 * 
...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			this.exceptionForward(request, response, e.getMessage());
			e.printStackTrace();
		} finally {
	...
	private void exceptionForward(HttpServletRequest request,
			HttpServletResponse response, String message)
			throws ServletException, IOException {
		errorMessage = "You either did not specify a file to upload or are "
				+ "trying to upload a file to a protected or nonexistent "
				+ "location. <br/> ERROR: " + message;
