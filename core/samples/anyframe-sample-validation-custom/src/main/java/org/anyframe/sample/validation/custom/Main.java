 ...
 */
package org.anyframe.sample.validation.custom;
...
import org.anyframe.sample.validation.custom.domain.Movie;
 ...
 * -Dexec.mainClass=org.anyframe.sample.validation.custom.Main
 * 
 * @author Jeryeon Kim
 */
public class Main {
	...
	public void validateMovieForDraftGroups() throws Exception {
		...
		movie.setTelephone("123.456.7890");
