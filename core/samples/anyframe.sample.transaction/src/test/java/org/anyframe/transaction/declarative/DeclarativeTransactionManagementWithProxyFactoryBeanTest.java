 ...
 */
public class DeclarativeTransactionManagementWithProxyFactoryBeanTest extends
    ...
    protected String[] getConfigLocations() {
        ...
        return new String[] {
            ...
            "classpath*:/META-INF/spring/integration/user/context-user-proxyfactorybean.xml" };
    }
