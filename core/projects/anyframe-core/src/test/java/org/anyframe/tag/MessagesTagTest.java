...
/**
 * 
 * We changed org.springframework.web.servlet.tags.MessageTagTests Class into org.anyframe.tag.MessagesTagTest Class in Anyframe.
 * <ul>
...
public class MessagesTagTest extends AbstractTagTests {
	...
	public void testMessagesTagWithMessageSourceResolvable1Korean() throws JspException {
		//Test test = new Test();
	...
	public void testMessagesTagWithMessageSourceResolvable1UnicodeKorean() throws JspException {
		PageContext pc = createPageContext();
		final StringBuffer message = new StringBuffer();
		MessagesTag tag = new MessagesTag() {
			protected void writeMessage(String msg) {
	...
	public void testMessagesTagWithMessageSourceResolvable1() throws JspException {
		PageContext pc = createPageContext();
		final StringBuffer message = new StringBuffer();
		MessagesTag tag = new MessagesTag() {
			protected void writeMessage(String msg) {
	...
	public void testMessagesTagWithCodeAndStringArgumentWithCustomSeparator() throws JspException {
		PageContext pc = createPageContext();
		final StringBuffer message = new StringBuffer();
		MessagesTag tag = new MessagesTag() {
			protected void writeMessage(String msg) {
	...
	public void testMessagesTagWithTextAndJavaScriptEscape() throws JspException {
		PageContext pc = createPageContext();
		final StringBuffer message = new StringBuffer();
		MessagesTag tag = new MessagesTag() {
			protected void writeMessage(String msg) {
	...
	public void testMessagesTagWithTextAndHtmlEscapeAndJavaScriptEscape() throws JspException {
		PageContext pc = createPageContext();
		final StringBuffer message = new StringBuffer();
		MessagesTag tag = new MessagesTag() {
			protected void writeMessage(String msg) {
