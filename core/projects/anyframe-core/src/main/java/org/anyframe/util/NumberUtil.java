...
public class NumberUtil {
	 ...
	 * 	- 예를 들어, 5277095325298.2523이라는 값에 "###,###.##"이라는 포맷을 적용하면 "5,277,095,325,298.25"로 변환된다.<br>
	 * 	- 그러나, 5277095325298.2523이라는 값에 "###,###.####"이라는 포맷을 적용하면 "5,277,095,325,298.252"로 변환된다.<br>
	 * 	- 마찬가지로 111115277095325298.2523이라는 값에 "###,###.##"이라는 포맷을 적용하면 "111,115,277,095,325,296"로 변환된다.<br>
	 * 	- 이것은, Java에서의 double 한계에 기인한 것이다.<br>
	 * </div>
	 * <pre>
	 ...
	 * str may allow ',' and '.' chars.<br>
   	 * <div class="ko">
	 * 소스 숫자 문자열을 해당 포맷형식의 숫자 문자열로 변환함<br>
	 * 화폐 표시에 사용하는 ,와 소수점을 표시하는 .을 제외한 다른 문자가 포함되어 있으면 안됨<br>
	 * </div>
	 * 
	 * <pre>
	 ...
	 * <div class="ko"> 제공된 숫자를 지정된 크기만큼 왼쪽으로 '0'이 패딩된 문자열을 반환한다. 만약 제공된 숫자의
	 * 문자열이 패딩할 크기보다 크면 해당 숫자의 문자열을 반환한다. </div>
	 * 
	 * @param i
