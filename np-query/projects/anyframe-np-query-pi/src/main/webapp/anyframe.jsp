...
<!--np-query-configuration-START-->
						<li><a href="<c:url value='/np-query/index.html'/>">NP-Query 1.6.0</a></li>

<!--np-query-configuration-END-->
<!--query-ria-configuration-START-->
<li>Query-ria 1.6.0</li>
<!--query-ria-configuration-END-->
<!--query-configuration-START-->
                            <!--<li><a href="<c:url value='/queryMovieFinder.do?method=list'/>">Query 1.6.1</a></li>-->
