...
/**
 * Using NPResponseHandler class, NEXACRO data is transformed to response.
 * 
 * @author Youngmin Jo
 *
 */
public class NPResponseHandler {
	...
	public NPResponseHandler() {
		this(new DataSetList(), new VariableList());
	}
	
	public NPResponseHandler(DataSetList outputDataSetList,
