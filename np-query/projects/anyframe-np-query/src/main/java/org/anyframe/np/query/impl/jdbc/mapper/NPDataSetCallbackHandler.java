 ...
 * @author Soyon Lim
 */
public class NPDataSetCallbackHandler extends NPCallbackSupport implements
		RiaRowCallback {
	...
	// Default Constructor
	public NPDataSetCallbackHandler() {
	...
	public NPDataSetCallbackHandler(DataSet dataSet, QueryInfo queryInfo) {
