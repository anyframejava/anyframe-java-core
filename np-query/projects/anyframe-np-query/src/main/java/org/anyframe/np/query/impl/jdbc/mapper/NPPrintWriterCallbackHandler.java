...
/**
 * Class for Print Writer NP DataSet
 * 
 * @author Soyon Lim
 * @author JongHoon Kim
 */
public class NPPrintWriterCallbackHandler extends NPCallbackSupport implements
	...
	// Default Constructor
	public NPPrintWriterCallbackHandler() {

	}

	public NPPrintWriterCallbackHandler(PrintWriter writer, QueryInfo queryInfo) {
		this.writer = writer;
