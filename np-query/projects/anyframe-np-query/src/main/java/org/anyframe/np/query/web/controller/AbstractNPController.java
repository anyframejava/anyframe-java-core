 ...
 */
package org.anyframe.np.query.web.controller;
...
/**
 * Abstract AbstractNPController Class which provide convert data, operation,
 * set message features. <br>
 * This Class contains useful methods using 'NEXACRO' that is a software
 ...
 * @deprecated
 */
public abstract class AbstractNPController extends AbstractController {
	/**
	...
	protected Logger logger = LoggerFactory
			.getLogger(AbstractNPController.class);
