...
<%@ include file="/sample/common/top.jsp"%>
		<div class="location"><a href="<c:url value='/anyframe.jsp'/>">Home</a> &gt; <a href="<c:url value='/sockJSMovieFinder.do'/>">Sockjs 1.0.1-SNAPSHOT</a></div>
    </div>
    <hr />
<script type="text/javascript" src="<c:url value='/sample/javascript/CommonScript.js'/>"></script>
<script type="text/javascript" src="<c:url value='/sockjs/jquery/js/jquery-1.9.0.min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/sockjs/jquery/js/jquery.jqGrid.src.js'/>"></script>
<script type="text/javascript" src="<c:url value='/sockjs/sockjs-0.3.4.min.js'/>"></script>
<script type="text/javascript">
	$(window).bind('resize', function() {
	    $("#movieGrid").setGridWidth($(window).width() - 30);
	}).trigger('resize');
	
	var url = "http://" + window.location.host + "<c:url value='/_sockjs_/getSockJSMovieList.do'/>";
	var ws = null;
    /*
    websocket
    xhr-polling
