...
<head>
	...
	function fncCreateMovie() {
	    document.movieForm.action="<c:url value='/queryMovie.do?method=create'/>";
	    document.movieForm.submit();
	}
	
	function fncUpdateMovie() {
	    document.movieForm.action="<c:url value='/queryMovie.do?method=update'/>";
	    document.movieForm.submit();
	}
	
	function fncRemoveMovie(){	
		if(confirmDelete('movie')) {
		    document.movieForm.action="<c:url value='/queryMovie.do?method=remove'/>";
		    document.movieForm.submit();
		}	    
	}	
	</script>         
