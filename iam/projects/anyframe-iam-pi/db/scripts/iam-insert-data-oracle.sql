...
CREATE TABLE GROUPS_HIERARCHY ( 
  PARENT_GROUP  VARCHAR2 (20)  NOT NULL, 
  CHILD_GROUP   VARCHAR2 (20)  NOT NULL, 
  CREATE_DATE   VARCHAR2 (8), 
  MODIFY_DATE   VARCHAR2 (8), 
...
CREATE TABLE RESTRICTED_TIMES (
	...
	SYSTEM_NAME VARCHAR2 (15) NOT NULL,
...
CREATE TABLE CANDIDATE_SECURED_RESOURCES (
	CANDIDATE_RESOURCE_ID	VARCHAR2 (10)		NOT NULL,
	SYSTEM_NAME 			VARCHAR2 (15),
	BEANID					VARCHAR2 (128),
