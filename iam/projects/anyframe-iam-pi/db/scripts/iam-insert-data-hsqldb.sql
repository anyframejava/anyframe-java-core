...
CREATE MEMORY TABLE GROUPS ( GROUP_ID VARCHAR (20) NOT NULL, GROUP_NAME VARCHAR (50) NOT NULL, CREATE_DATE VARCHAR (8), MODIFY_DATE VARCHAR (8), CONSTRAINT PK_GROUPS PRIMARY KEY ( GROUP_ID ) ) ; 
...
CREATE MEMORY TABLE IDS( TABLE_NAME VARCHAR(16) NOT NULL, NEXT_ID NUMERIC(30) NOT NULL, PRIMARY KEY(TABLE_NAME));
