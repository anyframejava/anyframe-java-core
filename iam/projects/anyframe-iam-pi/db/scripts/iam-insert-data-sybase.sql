...
CREATE TABLE CANDIDATE_SECURED_RESOURCES (
	...
	CLASSES					VARCHAR (128)   NULL,
	METHOD					VARCHAR (128)   NULL,
	PARAMETER				VARCHAR (128)   NULL,
	REQUESTMAPPING			VARCHAR (128)   NULL,
	POINTCUT				VARCHAR (128)   NULL,
